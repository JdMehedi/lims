...
<div id="renewForm">
    ...
    <fieldset>
        @includeIf('common.subviews.licenseInfo', ['mode' => 'renew-form','url'=> 'nix-license-renew/fetchAppData'])
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <div style="margin-top: 20px; {{ ($appInfo->declaration_q3 == 'Yes') ? 'display:block;' :'display:none;' }}" id="if_declaration_q3_yes">
                                    {{ Form::textarea('declaration_q3_text', ($appInfo->declaration_q3 == 'Yes') ? $appInfo->declaration_q3_text : null, array('class' =>'form-control input input_disabled','id'=>'declaration_q3_text', 'placeholder'=>'Enter Please give details', 'cols' => 5, 'rows' =>5, '' => ''))}}

                                </div>

                            </li>
                            <li><span class="i_we_dynamic">{{ $appInfo->org_type == 2 ? 'I' : 'We' }}</span> hereby
                            ...
                            <li style="margin-top: 20px;"><span
                                    class="i_we_dynamic">{{ $appInfo->org_type == 2 ? 'I' : 'We' }}</span> hereby
                            ...
                            <li style="margin-top: 20px;"><span
                                    class="i_we_dynamic">{{ $appInfo->org_type == 2 ? 'I' : 'We' }}</span> understand
    ...
    <div class="float-right">
        ...
        @if($appInfo->status_id == 5)
            <button type="button" id="submitForm"
                    ...
                    class="btn btn-info btn-md" onclick="openPreview()"
