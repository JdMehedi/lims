    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        <div class="card border-magenta">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    {{ Form::hidden('license_no', $license_no) }}
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'amendment-form'])
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            <table class="table table-bordered" id="equipment_tbl">
                                ...
                                <tr row_id="equipment_1">
                                            <td>1</td>
                                            <td><input type="text" value="" class="form-control" readonly name="equipment_name[0]" placeholder="Enter equipment name"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="equipment_brand_model[0]" placeholder="Enter brand & model"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="equipment_quantity[0]" placeholder="Enter quantity"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="equipment_remarks[0]" placeholder="Enter remarks"></td>
                                            <td class="d-flex justify-content-center"><button class="btn btn-success rounded-circle input_disabled btn-sm text-white add_row" type="button"><i class="fa fa-plus"></i></button></td>
                                        </tr>   
                                @endif
                                </tbody>
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            <table class="table table-bordered" id="tariffChart_tbl">
                                ...
                                <tr row_id="tariffChart_1">
                                            <td>1</td>
                                            <td><input type="text" value="" class="form-control" readonly name="tariffChart_package_name_plan[0]" placeholder="Enter packages name/ plan"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="tariffChart_bandwidth_package[0]" placeholder="Enter Speed (Kbps/Mbps)"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="tariffChart_price[0]" placeholder="Enter price(BDT)"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="tariffChart_duration[0]" placeholder="Enter duration"></td>
                                            <td><input type="text" value="" class="form-control" readonly name="tariffChart_remarks[0]" placeholder="Enter remarks"></td>
                                            <td class="d-flex justify-content-center"><button class="btn btn-success input_disabled rounded-circle btn-sm text-white add_row" type="button"><i class="fa fa-plus"></i></button></td>
                                        </tr> 
                                @endif
                                </tbody>
