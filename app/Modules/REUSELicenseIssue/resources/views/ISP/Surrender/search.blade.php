...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        <div class="card border-magenta">
            <h4 class="card-header">Application For New Internet Service Provider (ISP) License Surrender</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    ...
                    <div class="card card-magenta border border-magenta">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            ...
                            <div class="row isp_type_options" >
                                <div class="col-md-6">
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between areaAddress">
                           <div> Service Profile (If Applicable)</div>
                            <div>
                                <label class="serviceEditBtn">
                                    <input type="checkbox" id="serviceProfile"/>
                                    EDIT
                                </label>
                            </div>
                        ...
                        <div class="card-body"  id="serviceAllField" style="padding: 15px 25px;">
                            <br>
                            ...
                            <div class="card card-magenta border border-magenta">
                                ...
                                <div class="card-body " id="serviceEditable" style="padding: 15px 25px;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                ...
                                @if(isset($isp_equipment_list) && count($isp_equipment_list) > 0)
                                    @foreach($isp_equipment_list as $index=>$value)
                                        <tr row_id="equipment_{{$index+1}}">
                                            <td>{{$index+1}}</td>
                                            <td><input type="text" value="{{ $value->name }}" class="form-control" readonly
                                                       name="equipment_name[{{$index}}]" placeholder="Enter equipment name"></td>
                                            <td><input type="text" value="{{ $value->brand_model }}" class="form-control" readonly
                                                       name="equipment_brand_model[{{$index}}]" placeholder="Enter brand & model">
                                            </td>
                                            <td><input type="text" value="{{ $value->quantity }}" class="form-control" readonly
                                                       name="equipment_quantity[{{$index}}]" placeholder="Enter quantity"></td>
                                            <td><input type="text" value="{{ $value->remarks }}" class="form-control" readonly
                                                       name="equipment_remarks[{{$index}}]" placeholder="Enter remarks"></td>
                                            <td class="d-flex justify-content-center">
                                                <button
                                                    class="btn btn-success rounded-circle input_disabled btn-sm text-white add_row"
                                ...
                                @if(isset($isp_tariff_chart_list) && count($isp_tariff_chart_list) > 0)
                                    @foreach($isp_tariff_chart_list as $index=>$value)
                                        <tr row_id="tariffChart_{{$index+1}}">
                                            <td>{{$index+1}}</td>
                                            <td><input type="text" value="{{ $value->package_name_plan }}" class="form-control"
                                                       readonly name="tariffChart_package_name_plan[{{$index}}]"
                                                       placeholder="Enter packages name/ plan"></td>
                                            <td><input type="text" value="{{ $value->bandwidth_package }}" class="form-control"
                                                       readonly name="tariffChart_bandwidth_package[{{$index}}]"
                                                       placeholder="Enter Speed (Kbps/Mbps)"></td>
                                            <td><input type="text" value="{{ $value->price }}" class="form-control" readonly
                                                       name="tariffChart_price[{{$index}}]" placeholder="Enter price(BDT)"></td>
                                            <td><input type="text" value="{{ $value->duration }}" class="form-control" readonly
                                                       name="tariffChart_duration[{{$index}}]" placeholder="Enter duration"></td>
                                            <td><input type="text" value="{{ $value->remarks }}" class="form-control" readonly
                                                       name="tariffChart_remarks[{{$index}}]" placeholder="Enter remarks"></td>
                                            <td class="d-flex justify-content-center">
                                                <button
...
{!! Form::label('proposal_employee_${lastRowId+1}', 'Proposed of Employee', ['class' => 'col-md-4']) !!}
    ...
    <div class="row">
        ...
        $("#serviceProfile").click(function () {
            if (this.checked){
                makeReadWriteByServiceId('serviceAllField');
            }
            else {
                makeReadOnlyByServiceId('serviceAllField');
            }
        });

        function makeReadOnlyByServiceId(id) {
            const inputFieldsList = document.querySelectorAll(`#${id} input, #${id} select`);
            const labels = document.querySelectorAll(`#${id} label, #${id} .serviceEditBtn`);
        ...
        function makeReadWriteByServiceId(id) {
            const inputFieldsList = document.querySelectorAll(`#${id} input, #${id} select`);
            const labels = document.querySelectorAll(`#${id} label, #${id} .serviceEditBtn`);
            inputFieldsList.forEach(item => {
