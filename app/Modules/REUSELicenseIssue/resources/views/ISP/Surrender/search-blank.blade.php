...
<div class="row">
    <div class="col-md-12 col-lg-12" class="renewForm">
        <div class="card border-magenta">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'isp-license-surrender/fetchAppData'])
                    {{-- Company Informaiton --}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div
                                                    ...
                                                    {!! Form::text('location_of_ins_address','', ['class' => 'form-control', 'placeholder' => 'Enter  Address', 'id' => 'location_of_ins_address']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 {{ $errors->has('list_of_clients') ? 'has-error' : '' }}">
                                                    {{ Form::file('list_of_clients',['class'=>'form-control input','id'=>'list_of_clients','onchange'=>"createObjUrl('if_declaration_q3_yes','declaration_q3_images_base64')",])}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/isp-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
