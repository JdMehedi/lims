                                ...
                                <div class="col-md-6" id="division" style="display: none;">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('contact_district') ? 'has-error' : '' }}">
                                            {!! Form::select('isp_licensese_area_division', $divisions, $appInfo->isp_license_division, ['class' => 'form-control', 'id' => 'isp_licensese_area_division']) !!}
                                ...
                                <div class="col-md-6" id="district" style="display: none;">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('isp_licensese_area_district') ? 'has-error' : '' }}">
                                            {!! Form::select('isp_licensese_area_district', $districts, $appInfo->isp_license_district, ['class' => 'form-control', 'id' => 'isp_licensese_area_district', 'onchange' => "getThanaByDistrictId('isp_licensese_area_district', this.value, 'isp_licensese_area_thana',0)"]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row" id="thana" style="display: none;">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('isp_licensese_area_thana') ? 'has-error' : '' }}">
                                            {!! Form::select('isp_licensese_area_thana',[''=>'Select'],$appInfo->isp_license_upazila, ['class' => 'form-control', 'id' => 'isp_licensese_area_thana']) !!}
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        {{ Form::file('list_of_clients',['class'=>"form-control input $listOfClientRequiredClass",'id'=>'list_of_clients', 'onchange'=>"validateFile(event,'list_of_clients_images_base64')"])}}
...
{{--                    </div>--}}
                                ...
                                <div class="col-md-12 table-responsive border border-header-box">
                                    ...
                                    <table class="table table-bordered" id="bandwidth_tbl">
                                        ...
                                        <tr row_id="bandwidth_{{$index+1}}">
                                            <td>{{ $index+1 }}</td>
                                            <td><input type="text" class="form-control" value="{{ $value->name_of_primary_iig }}" name="bandwidth_primary_iig[{{$index}}]" placeholder="Enter Name of the primary IIG"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->allocation }}" name="bandwidth_allocation[{{$index}}]" placeholder="Enter Allocation"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->upstream }}" name="bandwidth_up_stream[{{$index}}]" placeholder="Enter Up Stream"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->downstream }}" name="bandwidth_down_stream[{{$index}}]" placeholder="Enter Down Stream"></td>
                                            <td class="d-flex justify-content-center">
                                                @if($index == 0)
                    ...
                    <div class="card card-magenta border border-magenta">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            ...
                            <div class="row">
                                <div class="col-md-12 border border-header-box table-responsive">
                                    ...
                                    <table class="table table-bordered" id="connectivity_tbl">
                                        ...
                                        <tr row_id="connectivity_{{$index+1}}">
                                            <td>{{$index+1}}</td>
                                            <td><input type="text" class="form-control" value="{{ $value->con_provider }}" name="connectivity_provider[{{ $index }}]" placeholder="Enter Connectivity provider"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->allocation_upstream }}" name="connectivity_up_stream[{{ $index }}]" placeholder="Enter Up Stream"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->allocation_downstream }}" name="connectivity_down_stream[{{ $index }}]" placeholder="Enter Down Stream"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->frequency_up }}" name="connectivity_up_frequency[{{ $index }}]" placeholder="Enter Up"></td>
                                            <td><input type="number" class="form-control" value="{{ $value->frequency_down }}" name="connectivity_down_frequency[{{ $index }}]" placeholder="Enter Down"></td>
                                            <td class="d-flex justify-content-center">
                                            @if($index == 0)
                                                <button class="btn btn-success rounded-circle btn-sm text-white add_row" type="button"><i class="fa fa-plus"></i></button>
                                            @else
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <div style="margin-top: 20px;">
                                               ...
                                               size="300x300" onchange="generateBase64String('if_declaration_q3_yes','declaration_q3_images_base64')" />
    ...
    $(document).ready(function() {
        ...
        $(".addContactPersonRow").on('click', function() {
            ...
            <div class="card card-magenta border border-magenta" style="margin-top: 20px;" id="contact_${updateRowId}">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                    <div class="card-body client-rendered-row" style="padding: 5px 0px 0px;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
...
{!! Form::label('contact_mobile_${updateRowId}', 'Mobile Number', ['class' => 'col-md-4']) !!}
            ...
            {!! Form::text('contact_mobile[${updateRowId}]', '', ['class' => 'form-control contact_mobile', 'placeholder' => 'Enter Mobile Number', 'id' => 'contact_mobile_${updateRowId}','onkeyup' => 'mobile_no_validation(this.id)']) !!}
                    ...
                    <div class="row" style="margin-bottom:0px!important; padding-bottom:0px!important;">
                        ...
                        <div class="col-md-4">
                            <label class="center-block image-upload" for="correspondent_photo_${updateRowId}">
                                ...
                                <input type="hidden" id="correspondent_photo_base64_${updateRowId}" name="correspondent_photo_base64[]" />
                            </label>
                        </div>
                </div>
            </div>
