    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between">
                <h4>Application for Internet Protocol Telephony Service Provider (IPTSP) License Amendment</h4>
                <div class="clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"  >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('types_of_isp_license') ? 'has-error' : '' }}">
                                    ...
                                    @foreach($iptsp_connected_isp_info as $item=>$value)
                                        <tr row_id="IPTSPlistOfISPinformation_{{$totalRow}}">
                                            ...
                                            @if($item == 0)
                                                <td><button class="btn btn-success rounded-circle btn-sm text-white add_row input_disabled" type="button"><i class="fa fa-plus"></i></button></td>
                                            @else
                                                <td><button class="btn btn-danger rounded-circle btn-sm text-white remove_row input_disabled" type="button"><i class="fa fa-minus"></i></button></td>
                                            @endif
                                        </tr>
                                    @endforeach
                                @endif
