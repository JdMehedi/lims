    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between">
                <h4>Application for Internet Protocol Telephony Service Provider (IPTSP) License Surrender</h4>
                <div class="clearfix">
...
<script type="text/javascript">
    $(function () {
        ...
        $("#backup_information").click(function () {
            ...
            if (this.checked){
                makeReadWriteByDivId('backup_information_div');
                $('#backup_info_of_description').removeClass('input_disabled');
            } 
            else {
                makeReadOnlyByDivId('backup_information_div');
