    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-body">
                ...
                {{--                <br>--}}
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'iptsp-license-cancellation/fetchAppData'])
                    {{-- Company info --}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/iptsp-license-cancellation/list/'. Encryption::encodeId(24)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
