            ...
            <div class="card-header">
                ...
                <span style="float: right; cursor: pointer;" class=" m-l-auto">
                               <i class="fa fa-info-circle text-dark" aria-hidden="true"></i>
                                {!! Form::checkbox('signatorySameAsContact', 'YES', false, ['id'=> 'signatorySameAsContact','class'=> 'm-2']) !!}
            ...
            <div class="card-body" style="padding: 15px 25px;">
                <div class="row">
                    ...
                    <div class="col-md-6"  >
                        ...
                        <div class="form-group row">
                            <div class="col-md-7 {{ $errors->has('gross_revenue_eamed_in_last_year_img') ? 'has-error' : '' }}">
                                <input type="file"
                                       style="border: none; margin-bottom: 5px;"
                                       class="input-sm"
