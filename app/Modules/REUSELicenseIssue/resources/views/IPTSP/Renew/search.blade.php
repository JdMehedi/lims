...
<div id="renewForm">
    ...
    {{--                <br>--}}
    <fieldset>
        @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'iptsp-license-renew/fetchAppData'])
        {{-- Company info --}}
        ...
        <div class="card card-magenta border border-magenta">
            ...
            <div class="card-body"id="coverage_area_information_div" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('coverage_area', 'Coverage Area :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('coverage_area') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group row">
                            {!! Form::label('total_coverage_area', 'Total Coverage Area : ', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('total_coverage_area') ? 'has-error' : '' }}">
        ...
        <div class="card card-magenta border border-magenta">
            ...
            <div class="card-body" id="coverage_out_of_area_div" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('coverage_out_of_area', 'Coverage Area :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('coverage_out_of_area') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group row">
                            {!! Form::label('total_coverage_out_of_area', 'Total Coverage Area : ', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('total_coverage_out_of_area') ? 'has-error' : '' }}">
        ...
        <div class="card card-magenta border border-magenta">
            ...
            <div class="card-body" id="wireless_network_information_div" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('wireless_number_of_bis_pop', 'Number of BIS/POP :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('wireless_number_of_bis_pop') ? 'has-error' : '' }}">
        ...
        <div class="card card-magenta border border-magenta">
            ...
            <div class="card-body" id="backup_information_div" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('backup_info_of_number_of_vsat', 'Number of VSAT (If Applicable) :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('backup_info_of_number_of_vsat') ? 'has-error' : '' }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('backup_info_of_downlink_allocation', 'Downlink Allocation :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('backup_info_of_downlink_allocation') ? 'has-error' : '' }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('backup_info_of_downlink_frequency', 'Downlink Frequency :', ['class' => 'col-md-5']) !!}
                            <div class="col-md-7 {{ $errors->has('backup_info_of_downlink_frequency') ? 'has-error' : '' }}">
