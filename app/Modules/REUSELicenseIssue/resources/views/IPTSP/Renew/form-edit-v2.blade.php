...
<div id="renewForm">
    ...
    <div class="card border border-magenta" style="border-radius: 10px; ">
        <div class="card-header d:flex justify-between" style="background: #28A745; color: white;">
    ...
    <fieldset>
        ...
        {{--contact person--}}
        @includeIf('common.subviews.ContactPerson', ['mode' => 'renew' , 'extra' => ['address2']git , 'selected' => 1])
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 {{ $errors->has('isp_license_number') ? 'has-error' : '' }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 {{ $errors->has('isp_license_date_of_expire') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            {!! Form::label('multi_license', 'Other License Awarded by the commision to the License :', ['class' => 'col-md-2']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6"  >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5 {{ $errors->has('gross_revenue_eamed_in_last_year') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6" >
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 {{ $errors->has('coverage_district') ? 'has-error' : '' }}">
                                {!! Form::select('coverage_district[]', $multiDistricts, null, ['class'=>'form-control multiple_select2','style'=>'width:100%', 'data-rule-maxlength'=>'40', 'id'=>"coverage_district","multiple"=>"multiple"]) !!}
    ...
    <div class="float-left">
        <a href="{{ url('/iptsp-license-renew/list/'. Encryption::encodeId(23)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
    ...
    <div class="float-right">
        ...
        <button type="button" id="submitForm" style="margin-right: 180px; position: relative; z-index: 99999; display: none;"
                class="btn btn-success btn-md" value="submit" onclick="openPreview()" name="actionBtn">Submit
        </button>
        {{--        @endif--}}
