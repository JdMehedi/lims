...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border border-magenta" style="border-radius: 10px; ">
            <div class="card-header" style=" display: flex; justify-content: space-between; background: #28A745; color: white;">
                <h4>Application for Internet Protocol Telephony Service Provider (IPTSP) License Renew</h4>
                <div class="clearfix" style="margin-left: auto;">
                    @if (in_array($appInfo->status_id, [5]))
                        <div class="col-md-12">
                            <div class="float-right">
                                <a data-toggle="modal" data-target="#remarksModal">
                                    {!! Form::button('<i class="fa fa-eye"></i>Reason of ' . $appInfo->status_name . '', ['type' => 'button', 'class' => 'btn btn-md btn-secondary', 'style'=>'white-space: nowrap;']) !!}
                                </a>
                            </div>
                        </div>
                    @endif
            ...
            <div style="display: none;" id="pcsubmitadd">
                ...
                {!! Form::hidden('issue_tracking_no', $appInfo->issue_tracking_no, ['class' => 'form-control input-md required', 'id' => 'app_id']) !!}
            </div>
            ...
            {{--                <br>--}}
            <fieldset>
                @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-form-edit', 'url' => 'iptsp-license-renew/fetchAppData'])
                {{-- Company info --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7 {{ $errors->has('isp_license_date_of_expire') ? 'has-error' : '' }}">
                                        {!! Form::text('isp_license_issue_date', isset($appInfo->isp_license_issue_date) && $appInfo->isp_license_issue_date != '0000-00-00' ? $appInfo->isp_license_issue_date : '', ['class'=>'form-control', 'readonly'=>true, 'id'=>'isp_license_issue_date']) !!}
                                        {!! $errors->first('isp_license_date_of_expire', '<span class="help-block">:message</span>') !!}
                                    </div>
                                </div>
                            </div>
            ...
            <fieldset>
                ...
                <div class="card card-magenta border border-magenta">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="ml-auto">
                            <label class="amendmentEditBtn">
                                <input type="checkbox" id="coverage_out_of_area"/>
                                EDIT
                            </label>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered" id="IPTSPlistOfISPinformation_tbl">
                            ...
                            @if(isset($iptsp_connected_isp_info) && count($iptsp_connected_isp_info) == 0)
                                <tr row_id="IPTSPlistOfISPinformation_{{count($iptsp_connected_isp_info)+1}}">
                                    ...
                                    <td><button class="btn btn-success rounded-circle btn-sm text-white add_row input_disabled" type="button"><i class="fa fa-plus"></i></button></td>
                                </tr>
                            @else
                                    ...
                                    <li>
                                        ...
                                        <div style="margin-top: 20px;">
                                            <div id="if_declaration_q4_yes" style="display: none;">
                                                ...
                                                <div class="row" id="declaration_q4_given_commision">
                                                    <div class="col-md-6">
                                                        <div class="row form-group">
            ...
            <div class="float-left">
                <a href="{{ url('/iptsp-license-renew/list/'. Encryption::encodeId(22)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
{{--    @endisset--}}
    ...
    $(document).ready(function () {
        ...
        $('.finish').on('click', function (e) {
            ...
            popupWindow = window.open('<?php echo URL::to('/iptsp-license-issue/preview'); ?>', 'Sample', '');
        });
...
{!! Form::label('shareholder_nationality_${lastRowId+1}', 'Nationality', ['class' => 'col-md-4']) !!}
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('iptsp-license-renew/get-payment-data-by-license-type') }}",
        data: {
...
<script type="text/javascript">
    $(function () {
        ...
        $("#coverage_out_of_area").click(function () {
        ...
        $("#other_license_award").click(function () {
            if (this.checked) makeReadWriteByDivIdCustom('other_license_award_div');
            else makeReadOnlyByDivIdCustom('other_license_award_div');
        });
        ...
        $("#backup_information").click(function () {
            if (this.checked) makeReadWriteByDivIdCustom('backup_information_div');
            else makeReadOnlyByDivIdCustom('backup_information_div');
        });
        ...
        function makeReadOnlyByDivIdCustom(id) {
            const inputFieldsList = document.querySelectorAll(`#${id} input, #${id} select, #${id} textArea`);
            const labels = document.querySelectorAll(`#${id} label, #${id} .addShareholderRow`);
        ...
        function makeReadWriteByDivIdCustom(id) {
            const inputFieldsList = document.querySelectorAll(`#${id} input, #${id} select, #${id} textArea`);
            const labels = document.querySelectorAll(`#${id} label, #${id} .addShareholderRow`);
            inputFieldsList.forEach(item => {
                item.classList.remove('input_disabled');
