                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_dial_up') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_dial_up','',['class'=>'form-control', 'id'=>'existing_subscriber_dial_up','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_corporate') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_corporate', '', ['class'=>'form-control', 'id'=>"existing_subscriber_corporate",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_individual') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_individual', '', ['class'=>'form-control', 'id'=>"existing_subscriber_individual",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_broadband') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_broadband','', ['class'=>'form-control', 'id'=>'existing_subscriber_broadband','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_name_with_corporate_clients_subscriber_number') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_name_with_corporate_clients_subscriber_number','', ['class'=>'form-control', 'id'=>'existing_subscriber_name_with_corporate_clients_subscriber_number','placeholder'=>'Write a name & number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_length_of_laid_cable') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_length_of_laid_cable','',['class'=>'form-control', 'id'=>'wired_network_length_of_laid_cable','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_optical_fiber') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_optical_fiber', '', ['class'=>'form-control', 'id'=>"wired_network_optical_fiber",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_dsl') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_dsl', '', ['class'=>'form-control', 'id'=>"wired_network_dsl",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_adsl') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_adsl', '', ['class'=>'form-control', 'id'=>"wired_network_adsl",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_utp') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_utp','', ['class'=>'form-control', 'id'=>'wired_network_utp','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_stp') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_stp','', ['class'=>'form-control', 'id'=>'wired_network_stp','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_other') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_other','', ['class'=>'form-control', 'id'=>'wired_network_other','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_total_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_total_allocation','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_total_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_total_utilization') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_total_utilization','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_total_utilization','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_iig') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_iig",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_iplc') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_iplc','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_iplc','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_vsat') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_uplink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_iplc','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_uplink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_uplink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_uplink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_iplc','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_medium_uplink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_uplink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_downlink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_iplc','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_downlink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_downlink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_downlink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_iplc','',['class'=>'form-control', 'id'=>'bandwidth_lastyear_medium_downlink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_downlink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_name') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_name', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_name",'placeholder'=>'Write a name']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_iig', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_iig",'placeholder'=>'Write a provider']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_iplc', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_iplc",'placeholder'=>'Write a provider']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_vsat', '', ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_vsat",'placeholder'=>'Write a provider']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('subscriber_individual') ? 'has-error' : '' }}">
                                            {!! Form::text('subscriber_individual','',['class'=>'form-control', 'id'=>'subscriber_individual','placeholder'=>'Write a percentage'] ) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('subscriber_corporate') ? 'has-error' : '' }}">
                                            {!! Form::text('subscriber_corporate','', ['class'=>'form-control', 'id'=>'subscriber_corporate','placeholder'=>'Write a percentage'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('no_of_POP') ? 'has-error' : '' }}">
                                            {!! Form::text('no_of_POP','',['class'=>'form-control', 'id'=>'no_of_POP','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('location') ? 'has-error' : '' }}">
                                            {!! Form::text('location','', ['class'=>'form-control', 'id'=>'location','placeholder'=>'Write a location'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_number_of_vsat') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_number_of_vsat','',['class'=>'form-control', 'id'=>'backup_info_of_number_of_vsat','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('backup_info_of_uplink_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_uplink_allocation','', ['class'=>'form-control', 'id'=>'backup_info_of_uplink_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_downlink_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_downlink_allocation','',['class'=>'form-control', 'id'=>'backup_info_of_downlink_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('backup_info_of_uplink_frequency') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_uplink_frequency','', ['class'=>'form-control', 'id'=>'backup_info_of_uplink_frequency','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_downlink_frequency') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_downlink_frequency','',['class'=>'form-control', 'id'=>'backup_info_of_downlink_frequency','placeholder'=>'Write a number'] ) !!}
