...
{{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                    {{-- Company info --}}
                    @includeIf('common.subviews.CompanyInfo', ['mode' => 'edit', 'selected' => 1, 'extra' => ['address2']])

                    {{-- Applicant Profile --}}
                    @includeIf('common.subviews.ApplicantProfile', ['mode' => 'edit', 'selected' => 1, 'extra' => ['address2']])

                    {{--contact person--}}
                    @includeIf('common.subviews.ContactPerson', ['mode' => 'edit', 'selected' => 1, 'extra' => ['address2']])
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_person_name') ? 'has-error' : '' }}">
                                                {!! Form::text('contact_signatory_person_name', $appInfo->cs_person_name, ['class' => 'form-control', 'placeholder' => 'Enter Name', 'id' => 'contact_signatory_name']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_designation') ? 'has-error' : '' }}">
                                                {!! Form::text('contact_signatory_designation', $appInfo->cs_designation, ['class' => 'form-control', 'placeholder' => 'Enter Designation', 'id' => 'contact_signatory_designation']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_mobile') ? 'has-error' : '' }}">
                                                {!! Form::text('contact_signatory_mobile', $appInfo->cs_mobile, ['class' => 'form-control', 'placeholder' => 'Enter Mobile Number', 'id' => 'contact_signatory_mobile']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_person_email') ? 'has-error' : '' }}">
                                                {!! Form::text('contact_signatory_person_email', $appInfo->cs_person_email, ['class' => 'form-control', 'placeholder' => 'Email', 'id' => 'contact_signatory_email']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_district') ? 'has-error' : '' }}">
                                                {!! Form::select('contact_signatory_district', $districts, $appInfo->cs_district, ['class' => 'form-control', 'id' => 'contact_signatory_district_1', 'onchange' => "getThanaByDistrictId('contact_signatory_district_1', this.value, 'contact_signatory_thana_1',0)"]) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_thana') ? 'has-error' : '' }}">
                                                {!! Form::select('contact_signatory_thana', [], $appInfo->cs_thana, ['class' => 'form-control', 'placeholder' => 'Select district at first', 'id' => 'contact_signatory_thana_1']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('contact_signatory_person_address') ? 'has-error' : '' }}">
                                                {!! Form::text('contact_signatory_person_address', $appInfo->cs_person_address, ['class' => 'form-control', 'placeholder' => 'Enter  Address', 'id' => 'contact_signatory_person_address']) !!}
                                                ...
                                                <div class="row"
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="file"
                                                               ...
                                                               class="form-control input-sm signatoryImg"
                                                               name="contact_signatory_photo"
                                                               id="contact_signatory_photo"
                                                        ...
                                                        <label class="center-block image-upload"
                                                            ...
                                                            <figure>
                                                                <img style="height: 80px; width: 80px; border: 1px solid #EBEBEB;"
                                                                     src="{{ !empty($appInfo->cs_photo_base64) ? $appInfo->cs_photo_base64 : asset('assets/images/demo-user.jpg')  }}"
                                                                     class="img-responsive img-thumbnail"
                                                                     id="contact_signatory_photo_preview"/>
                                                            </figure>

                                                            <input type="hidden" id="contact_signatory_photo_base64"
                                                                   value="{{$appInfo->cs_photo_base64}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('isp_license_date_of_expire') ? 'has-error' : '' }}">
                                            {!! Form::text('isp_license_issue_date',$appInfo->isp_license_issue_date ?? '',['class'=>'form-control', 'readonly'=>true, 'id'=>'isp_license_issue_date'] ) !!}
                                            {!! $errors->first('isp_license_date_of_expire', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 {{ $errors->has('multi_license') ? 'has-error' : '' }}">
                                            {!! Form::select('multi_license[]', $multiLicense, json_decode($appInfo->multi_license), ['class'=>'form-control multiple_select2','style'=>'width:100%', 'data-rule-maxlength'=>'40', 'id'=>"multi_license","multiple"=>"multiple"]) !!}
                                            {!! $errors->first('multi_license', '<span class="help-block">:message</span>') !!}
                                        </div>

                                        <div class="col-md-2 {{ $errors->has('prev_license_copy') ? 'has-error' : '' }}">
                                        ...
                                        @isset($appInfo->prev_license_copy)
                                                <div class="col-md-2 {{ $errors->has('prev_license_copy') ? 'has-error' : '' }}">
                                                    <a class="btn btn-info" href="{{ asset($appInfo->prev_license_copy) }}" target="_blank">Open file</a>
                                                </div>
                                        @endisset
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('local_investment') ? 'has-error' : '' }}">
                                            {!! Form::text('local_investment',$appInfo->local_investment,['class'=>'form-control','placeholder'=>'Enter Local Investment', 'id' => 'local_investment', 'onkeyup'=>'investmentInfo()'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('total_investment') ? 'has-error' : '' }}">
                                            {!! Form::text('total_investment',$appInfo->total_investment,['class'=>'form-control','placeholder'=>'000','readonly'=>'readonly', 'id'=>'total_investment'] ) !!}
                                    ...
                                    <div class="form-group row pt-3">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('gross_revenue_eamed_in_last_year') ? 'has-error' : '' }}">
                                            {!! Form::text('gross_revenue_eamed_in_last_year',$appInfo->gr_rev_last_year,['class'=>'form-control','placeholder'=>'Enter Foreign Investment', 'id'=>'gross_revenue_eamed_in_last_year'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('foreign_investment') ? 'has-error' : '' }}">
                                            {!! Form::text('foreign_investment',$appInfo->foreign_investment,['class'=>'form-control','placeholder'=>'Enter Foreign Investment', 'id'=>'foreign_investment', 'onkeyup'=>'investmentInfo()'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('present_value_of_total_investment') ? 'has-error' : '' }}">
                                            {!! Form::text('present_value_of_total_investment',$appInfo->pre_val_t_invest,['class'=>'form-control','placeholder'=>'Enter Present Value of Total Investment', 'id'=>'present_value_of_total_investment'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('employee_information') ? 'has-error' : '' }}">
                                            {!! Form::text('employee_information',$appInfo->emp_info,['class'=>'form-control', 'id' => 'employee_information'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('total_it_specialist') ? 'has-error' : '' }}">
                                            {!! Form::text('total_it_specialist',$appInfo->tit_specialist,['class'=>'form-control', 'id'=>'total_it_specialist'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('type_of_iptsp_licensese') ? 'has-error' : '' }}">
                                            {!! Form::select('type_of_iptsp_licensese', [''=>'Select',1=>'Nationwide',2=>'Divisional'], $appInfo->isptspli_type, ['class' => 'form-control', 'id' => 'type_of_iptsp_licensese']) !!}
                                            {!! $errors->first('type_of_iptsp_licensese', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" id="division"
                                     style="display: {{(isset($appInfo->isptspli_type) && $appInfo->isptspli_type == 1) ? 'none' : 'block' }};">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('iptsp_licensese_area_division') ? 'has-error' : '' }}">
                                            {!! Form::select('iptsp_licensese_area_division',$divisions, $appInfo->isptspli_area_div, ['class' => 'form-control', 'id' => 'iptsp_licensese_area_division','onchange' => "getIPTSPiDistrictByDivisionId('iptsp_licensese_area_division', this.value, ['coverage_district','coverage_out_of_district'],[],[]);"]) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('total_coverage_area') ? 'has-error' : '' }}">
                                            {!! Form::text('total_coverage_area',$appInfo->t_cover_area, ['class'=>'form-control','placeholder'=>'In Square Kilometer', 'id'=>'total_coverage_area'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('coverage_district') ? 'has-error' : '' }}">
                                            {!! Form::select('coverage_district[]', $multiDistricts, json_decode($appInfo->cover_dis), ['class'=>'form-control multiple_select2','style'=>'width:100%', 'data-rule-maxlength'=>'40', 'id'=>"coverage_district","multiple"=>"multiple"]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('total_coverage_out_of_area') ? 'has-error' : '' }}">
                                            {!! Form::text('total_coverage_out_of_area',$appInfo->tc_out_area, ['class'=>'form-control','placeholder'=>'In Square Kilometer',  'id'=>'total_coverage_out_of_area'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 ">
                                            {!! Form::select('coverage_out_of_district[]', $multiDistricts, json_decode($appInfo->cover_ot_dis), ['class'=>'form-control multiple_select2', 'style'=>'width:100%', 'id'=>"coverage_out_of_district","multiple"=>"multiple"]) !!}
                                    ...
                                    <div class="form-group row" style="margin-top:10px;">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('commencement_date') ? 'has-error' : '' }}">
                                            <div class="input-group date datetimepickerCommencement"
                                                ...
                                                {!! Form::text('commencement_date', !empty($appInfo->commencement_date) ? \App\Libraries\CommonFunction::changeDateFormat($appInfo->commencement_date) : '', ['class' => 'form-control calendarIcon', 'id' => 'commencement_date']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_dial_up') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_dial_up',$appInfo->existsubs_dial_up, ['class'=>'form-control', 'id'=>'existing_subscriber_dial_up','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_corporate') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_corporate', $appInfo->existsubs_corporate, ['class'=>'form-control', 'id'=>"existing_subscriber_corporate",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_individual') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_individual', $appInfo->existsubs_individual, ['class'=>'form-control', 'id'=>"existing_subscriber_individual",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_broadband') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_broadband',$appInfo->existsubs_broadband, ['class'=>'form-control', 'id'=>'existing_subscriber_broadband','placeholder'=>'Write a number'] ) !!}
                                            {!! $errors->first('existing_subscriber_broadband', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        {!! Form::label('existing_subscriber_name_with_corporate_clients_subscriber_number', 'Name of Corporate Clients with Subscriber Number :', ['class' => 'col-md-4','placeholder'=>'Write a number']) !!}
                                        <div class="col-md-8 {{ $errors->has('existing_subscriber_name_with_corporate_clients_subscriber_number') ? 'has-error' : '' }}">
                                            {!! Form::text('existing_subscriber_name_with_corporate_clients_subscriber_number',$appInfo->exsubs_corpc_namenum, ['class'=>'form-control', 'id'=>'existing_subscriber_name_with_corporate_clients_subscriber_number','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_length_of_laid_cable') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_length_of_laid_cable',$appInfo->wirenet_len_lid_cabl, ['class'=>'form-control', 'id'=>'wired_network_length_of_laid_cable','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_optical_fiber') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_optical_fiber', $appInfo->wir_net_optic_fiber, ['class'=>'form-control', 'id'=>"wired_network_optical_fiber",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_dsl') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_dsl', $appInfo->wire_net_dsl, ['class'=>'form-control', 'id'=>"wired_network_dsl",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_adsl') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_adsl', $appInfo->wire_net_adsl, ['class'=>'form-control', 'id'=>"wired_network_adsl",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wired_network_utp') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_utp',$appInfo->wire_net_utp, ['class'=>'form-control', 'id'=>'wired_network_utp','placeholder'=>'Write a number'] ) !!}
                                            {!! $errors->first('wired_network_utp', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        {!! Form::label('wired_network_stp', 'STP :', ['class' => 'col-md-4','placeholder'=>'Write a number']) !!}
                                        <div class="col-md-8 {{ $errors->has('wired_network_stp') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_stp',$appInfo->wire_net_stp, ['class'=>'form-control', 'id'=>'wired_network_stp','placeholder'=>'Write a number'] ) !!}
                                            {!! $errors->first('wired_network_stp', '<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        {!! Form::label('wired_network_other', 'Other :', ['class' => 'col-md-4','placeholder'=>'Write a number']) !!}
                                        <div class="col-md-8 {{ $errors->has('wired_network_other') ? 'has-error' : '' }}">
                                            {!! Form::text('wired_network_other',$appInfo->wire_net_other, ['class'=>'form-control', 'id'=>'wired_network_other','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_total_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_total_allocation',$appInfo->bnd_lst_totl_alloc, ['class'=>'form-control', 'id'=>'bandwidth_lastyear_total_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_total_utilization') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_total_utilization',$appInfo->bnd_lst_totl_util,['class'=>'form-control', 'id'=>'bandwidth_lastyear_total_utilization','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_iig') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_iig', $appInfo->bnd_lst_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_iig",'placeholder'=>'Write a number']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_iplc') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_iplc',$appInfo->bnd_lst_iplc,['class'=>'form-control', 'id'=>'bandwidth_lastyear_iplc','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_vsat') ? 'has-error' : '' }}">
                                            {!! Form::text('bandwidth_lastyear_vsat', $appInfo->bnd_lst_prov_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_iig', $appInfo->bnd_lst_upli_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_uplink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_iplc',$appInfo->bnd_lst_upli_iplc,['class'=>'form-control', 'id'=>'bandwidth_lastyear_uplink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_uplink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_uplink_vsat', $appInfo->bnd_lst_upli_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_uplink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_iig', $appInfo->bnd_lst_med_upli_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_uplink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_iplc',$appInfo->bnd_lst_med_upli_iplc,['class'=>'form-control', 'id'=>'bandwidth_lastyear_medium_uplink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_uplink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_uplink_vsat', $appInfo->bnd_lst_med_upli_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_uplink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_iig', $appInfo->bnd_lst_downli_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_downlink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_iplc',$appInfo->bnd_lst_downli_iplc,['class'=>'form-control', 'id'=>'bandwidth_lastyear_downlink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_downlink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_downlink_vsat', $appInfo->bnd_lst_downli_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_downlink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_iig', $appInfo->bnd_lst_med_downli_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_downlink_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_iplc',$appInfo->bnd_lst_med_downli_iplc,['class'=>'form-control', 'id'=>'bandwidth_lastyear_medium_downlink_iplc','placeholder'=>'Write a number'] ) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_medium_downlink_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_medium_downlink_vsat', $appInfo->bnd_lst_med_downli_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_medium_downlink_vsat",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_name') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_name', $appInfo->bnd_lst_prov_name, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_name",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_iig') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_iig', $appInfo->bnd_lst_prov_iig, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_iig",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_iplc') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_iplc', $appInfo->bnd_lst_prov_iplc, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_iplc",'placeholder'=>'Write a number']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 {{ $errors->has('bandwidth_lastyear_provider_vsat') ? 'has-error' : '' }}">
                                                {!! Form::text('bandwidth_lastyear_provider_vsat', $appInfo->bnd_lst_prov_vsat, ['class'=>'form-control', 'id'=>"bandwidth_lastyear_provider_vsat",'placeholder'=>'Write a number']) !!}
                            ...
                            <table class="table table-bordered" id="IPTSPlistOfISPinformation_tbl">
                                ...
                                @if(isset($iptsp_connected_isp_info) && count($iptsp_connected_isp_info) == 0)
                                    <tr row_id="IPTSPlistOfISPinformation_{{count($iptsp_connected_isp_info)+1}}">
                                        ...
                                        <td><input type="text" class="form-control institution_name"
                                                   id="institution_name_1" placeholder="Institution Name"
                                                   name="institution_name[1]"></td>
                                        <td>
                                        ...
                                        <tr row_id="IPTSPlistOfISPinformation_{{$totalRow}}">
                                            ...
                                            <td>
                                                ...
                                                "2"=>"College",
                                                 "3"=>"University",
                                                 ""=>"Select"
                                                ], $value->institution_type, ["class"=>"form-control institution_type", "id"=>"institution_type_".$item]) !!}
                                            </td>
                                            <td><input type="text" class="form-control" id="institution_name_{{$item}}"
                                                       placeholder="Institution Name"
                                                       value="{{$value->institution_name}}"
                                                       name="institution_name[{{$item}}]"></td>
                                            @if($item == 0)
                                                <td>
                                                    <button class="btn btn-success rounded-circle btn-sm text-white add_row"
                                                            type="button"><i class="fa fa-plus"></i></button>
                                            ...
                                            @else
                                                <td>
                                                    <button class="btn btn-danger rounded-circle btn-sm text-white remove_row"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('subscriber_individual') ? 'has-error' : '' }}">
                                            {!! Form::text('subscriber_individual',$appInfo->subsc_indivi,['class'=>'form-control', 'id'=>'subscriber_individual','placeholder'=>'Write a percentage'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('subscriber_corporate') ? 'has-error' : '' }}">
                                            {!! Form::text('subscriber_corporate',$appInfo->subsc_corpo, ['class'=>'form-control', 'id'=>'subscriber_corporate','placeholder'=>'Write a percentage'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('no_of_POP') ? 'has-error' : '' }}">
                                            {!! Form::text('no_of_POP',$appInfo->no_of_POP,['class'=>'form-control', 'id'=>'no_of_POP','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('location') ? 'has-error' : '' }}">
                                            {!! Form::text('location',$appInfo->location, ['class'=>'form-control', 'id'=>'location','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wireless_number_of_bis_pop') ? 'has-error' : '' }}">
                                            {!! Form::text('wireless_number_of_bis_pop', $appInfo->wirls_num_bis_pop,['class'=>'form-control','placeholder'=>'Number of BIS/POP', 'id'=>'wireless_number_of_bis_pop'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('wireless_frequency') ? 'has-error' : '' }}">
                                            {!! Form::text('wireless_frequency',$appInfo->wireless_frequency, ['class'=>'form-control', 'placeholder'=>'Frequency', 'id'=>'wireless_frequency'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_number_of_vsat') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_number_of_vsat',$appInfo->bkupinf_num_of_vsat,['class'=>'form-control', 'id'=>'backup_info_of_number_of_vsat','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('backup_info_of_uplink_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_uplink_allocation',$appInfo->bkupinf_uplin_alloc, ['class'=>'form-control', 'id'=>'backup_info_of_uplink_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_downlink_allocation') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_downlink_allocation',$appInfo->bkupinf_downlin_alloc,['class'=>'form-control', 'id'=>'backup_info_of_downlink_allocation','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7 {{ $errors->has('backup_info_of_uplink_frequency') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_uplink_frequency',$appInfo->bkupinf_uplin_freq, ['class'=>'form-control', 'id'=>'backup_info_of_uplink_frequency','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('backup_info_of_downlink_frequency') ? 'has-error' : '' }}">
                                            {!! Form::text('backup_info_of_downlink_frequency',$appInfo->bkupinf_dwnlin_freq,['class'=>'form-control', 'id'=>'backup_info_of_downlink_frequency','placeholder'=>'Write a number'] ) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 {{ $errors->has('backup_info_of_description') ? 'has-error' : '' }}">
                                            {!! Form::textArea('backup_info_of_description',$appInfo->bkupinf_desc,['class'=>'form-control','placeholder'=>'Description', 'rows'=> 5, 'id'=>'backup_info_of_description'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('per_subscriber_individual') ? 'has-error' : '' }}">
                                            {!! Form::text('per_subscriber_individual',$appInfo->per_subsc_indivi,['class'=>'form-control','placeholder'=>'Individual ', 'id'=>'per_subscriber_individual'] ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('per_subscriber_corporate') ? 'has-error' : '' }}">
                                            {!! Form::text('per_subscriber_corporate',$appInfo->per_subsc_corpo, ['class'=>'form-control', 'placeholder'=>'Corporate', 'id'=>'per_subscriber_corporate'] ) !!}
                ...
                <fieldset>
                                    ...
                                    <ol>
                                        <li>
                                            <label class=" !font-normal">
                                                Has any Application for License of the Applicant any Share
                                                Holder/Partner ISP been rejected before?
                                            </label>

                                            <div style="margin-top: 20px;" id="declaration_q1">
                                                {{ Form::radio('declaration_q1', 'Yes', $appInfo->dclar_q1 == 'Yes' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline', 'id' => 'declaration_q1_yes']) }}
                                                {{ Form::label('declaration_q1_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                {{ Form::radio('declaration_q1', 'No',  $appInfo->dclar_q1 == 'No' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q1_no']) }}
                                            ...
                                            <div id="if_declaration_q1_yes" style="display: none">
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div class="col-md-4 {{ $errors->has('declaration_q1_date') ? 'has-error' : '' }}">
                                                        ...
                                                        <div class="input-group date  declaration_q1_datetimepicker"
                                                            ...
                                                            {!! Form::text('declaration_q1_date', !empty($appInfo->dclar_q1_date) ? \App\Libraries\CommonFunction::changeDateFormat($appInfo->dclar_q1_date) : '', ['class' => 'form-control calendarIcon', 'id' => 'declaration_q1_date', 'placeholder'=> date('d-M-Y') ] ) !!}
                                                            <div class="input-group-append"
                                                ...
                                                <div style="margin-top: 20px;">
                                                    {{ Form::textarea('declaration_q1_text',$appInfo->dclar_q1_text, array('class' =>'form-control input','id' => 'declaration_q1_text', 'placeholder'=>'Please give details reasons for rejection', 'cols' => 5, 'rows' =>5, '' => '' ))}}
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <label class="required-star !font-normal">
                                                Do the Applicant /Share Holder Partner hold any other Operator Licenses
                                                from the Commission?
                                            </label>

                                            <div style="margin-top: 20px;" id="declaration_q2">
                                                {{ Form::radio('declaration_q2', 'Yes', $appInfo->dclar_q2 == 'Yes' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline', 'id' => 'declaration_q2_yes']) }}
                                                {{ Form::label('declaration_q2_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                {{ Form::radio('declaration_q2', 'No', $appInfo->dclar_q2 == 'No' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q2_no']) }}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q2_service_list') ? 'has-error' : '' }}">
                                                                    {!! Form::select('declaration_q2_service_list',[''=>'Select', '1'=>'ISP','2'=>'NIX'], $appInfo->dclar_q2_serv_lst, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q2_service_list' ]) !!}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q2_license_number') ? 'has-error' : '' }}">
                                                                    {!! Form::text('declaration_q2_license_number', $appInfo->dclar_q2_licen_num, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q2_license_number' ]) !!}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q2_company_name') ? 'has-error' : '' }}">
                                                                    {!! Form::text('declaration_q2_company_name', $appInfo->dclar_q2_comp_name, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q2_company_name' ]) !!}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q2_share_holder_name') ? 'has-error' : '' }}">
                                                                    {!! Form::text('declaration_q2_share_holder_name', $appInfo->dclar_q2_shar_holdr_name, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q2_share_holder_name' ]) !!}
                                        ...
                                        <li>
                                            <label class="required-star !font-normal">
                                                Has any other License of the Applicant/any Share Holder/Partner been
                                                rejected before?
                                            </label>

                                            <div style="margin-top: 20px;" id="declaration_q3">
                                                {{ Form::radio('declaration_q3', 'Yes',$appInfo->dclar_q3 == 'Yes' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline', 'id' => 'declaration_q3_yes']) }}
                                                {{ Form::label('declaration_q3_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                {{ Form::radio('declaration_q3', 'No', $appInfo->dclar_q3 == 'No' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q3_no']) }}
                                            ...
                                            <div id="if_declaration_q3_yes" style="display: none">
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div class="col-md-4 {{ $errors->has('declaration_q3_date') ? 'has-error' : '' }}">
                                                        ...
                                                        <div class="input-group date  declaration_q3_datetimepicker"
                                                             ...
                                                             data-target-input="nearest">
                                                            {!! Form::text('declaration_q3_date',!empty($appInfo->dclar_q3_date) ? \App\Libraries\CommonFunction::changeDateFormat($appInfo->dclar_q3_date) : '', ['class' => 'form-control calendarIcon', 'id' => 'declaration_q3_date', 'placeholder'=> date('d-M-Y') ] ) !!}
                                                            <div class="input-group-append"
                                                ...
                                                <div style="margin-top: 20px;">
                                                    {{ Form::textarea('declaration_q3_text',$appInfo->dclar_q3_text, array('class' =>'form-control input','id' => 'declaration_q3_text', 'placeholder'=>'Please give details reasons for rejection', 'cols' => 5, 'rows' =>5, '' => '' ))}}
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <label class="required-star !font-normal">
                                                Do the Applicant/ its owner(s)/ any of its director(s)/ partner(s) were
                                                involved in any illegal call termination using VoIP technology?
                                            </label>

                                            <div style="margin-top: 20px;" id="declaration_q4">
                                                {{ Form::radio('declaration_q4', 'Yes', $appInfo->dclar_q4 == 'Yes' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline', 'id' => 'declaration_q4_yes']) }}
                                                {{ Form::label('declaration_q4_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                {{ Form::radio('declaration_q4', 'No', $appInfo->dclar_q4 == 'No' ? 'checked' : '', ['class'=>'form-check-input', 'style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q4_no']) }}
                                            ...
                                            <div style="margin-top: 20px;">
                                                <div id="if_declaration_q4_yes" style="display: none;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q4_illegal_VoIP_activities') ? 'has-error' : '' }}">
                                                                    {!! Form::text('declaration_q4_illegal_VoIP_activities', $appInfo->dclar_q4_iligl_VoIP_activiti, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q4_illegal_VoIP_activities' ]) !!}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-8{{ $errors->has('declaration_q4_case_no') ? 'has-error' : '' }}">
                                                                    {!! Form::text('declaration_q4_case_no', $appInfo->dclar_q4_case_no, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q4_case_no' ]) !!}
                                                    ...
                                                    <fieldset class="scheduler-border declaration_q4_last_part">
                                                        <legend class="scheduler-border">Administrative fine paid to the
                                                            Commission
                                                        </legend>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-md-8{{ $errors->has('declaration_q4_amount') ? 'has-error' : '' }}">
                                                                        {!! Form::text('declaration_q4_amount', $appInfo->dclar_q4_amount, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q4_amount' ]) !!}
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-md-8{{ $errors->has('declaration_q4_cheque_or_bank_draft_no') ? 'has-error' : '' }}">
                                                                        {!! Form::text('declaration_q4_cheque_or_bank_draft_no', $appInfo->dclar_q4_chq_bank_drft, ['class' => 'form-control', 'placeholder' => '','id'=>'declaration_q4_cheque_or_bank_draft_no' ]) !!}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-4"
                                                                     id="declaration_q4_given_commision">
                                                                    {{ Form::radio('declaration_q4_given_commision', 'Yes', $appInfo->dclar_q4_givn_commision == 'Yes' ? 'selected' : '', ['class'=>'form-check-input', 'style'=>'display: inline', 'id' => 'declaration_q4_given_commision_yes']) }}
                                                                    {{ Form::label('declaration_q4_given_commision_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                                    {{ Form::radio('declaration_q4_given_commision', 'No', $appInfo->dclar_q4_givn_commision == 'No' ? 'selected' : '', ['class'=>'form-check-input', 'style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q4_given_commision_no']) }}
                    ...
                    <div class="card card-magenta border border-magenta">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <li>Application without the submission of complete documents and information will
                                        not be accepted.
                                    </li>
                                    <li>Payment should be made by a Pay order / Demand Draft in favor of Bangladesh
                                        Telecommunication Regulatory Commission (BTRC).
                                    </li>
                                    <li>Application fee is not refundable.</li>
                                    <li>Application will not be accepted if information's do not fulfill the relevant
                                        terms and conditions of the Commission issued at various time.
                                    </li>
                                    <li>Any ISP' found involved with illegal VoIP business at any time shall not be
                                        eligible for any type of IPTSP License.
                                    </li>
                                </div>
                            </div>
                        </div>
                ...
                <div class="float-left">
                    <a href="{{ url('client/iptsp-license-issue/list/'. Encryption::encodeId(21)) }}"
...
<script>
    ...
    let org_district = '{{$appInfo->org_district}}';
    let org_upazila = '{{$appInfo->org_upazila}}';
    getThanaByDistrictId('office_district', org_district, 'office_upazilla_thana', org_upazila)
    @endisset

    @isset($appInfo->org_per_district)
    getThanaByDistrictId('par_office_district', {{ $appInfo->org_per_district ?? '' }},
        'par_office_upazilla_thana', {{ $appInfo->org_per_upazila ?? '' }});
    @endisset
...
{{--    @isset($appInfo->applicant_district)--}}
{{--    getThanaByDistrictId('applicant_district',{{ $appInfo->applicant_district ?? '' }},--}}
{{--        'applicant_upazila_thana_list',{{ $appInfo->applicant_upazila ?? '' }});--}}
{{--    @endisset--}}
    ...
    $(document).ready(function () {
        ...
        {{--                    {!! Form::select('contact_district[]', $districts, '', ['class' => 'form-control', 'id' => 'contact_district_'.'${updateRowId}', 'onchange' => 'getThanaByDistrictId("contact_district_${updateRowId}",this.value, "contact_thana_${updateRowId}",0)']) !!}--}}
        ...
        {{--                                                        {!! Form::select('contact_thana[]', [], '', ['class' => 'form-control', 'placeholder' => 'Select district at first', 'id' => 'contact_thana_'.'${updateRowId}']) !!}--}}
        ...
        {{--    <div class="col-md-6">--}}
        {{--        <div class="form-group row" style="margin-bottom:0px!important;">--}}
        {{--            {!! Form::label('contact_person_edit_image', 'Photograph', ['class' => 'col-md-4 required-star']) !!}--}}
        {{--            <div class="col-md-8 {{ $errors->has('shareholder_image') ? 'has-error' : '' }}">--}}
        {{--                <div class="row" style="margin-bottom:0px!important; padding-bottom:0px!important;">--}}
        {{--                    <div class="col-md-8">--}}
        {{--                        <input type="file"--}}
        {{--                               class="form-control input-sm {{ !empty(Auth::user()->user_pic) ? '' : '' }}"--}}
        {{--                               name="contact_photo[]" id="contact_photo_edit_${updateRowId}"--}}
...
{!! Form::label('shareholder_nationality_${lastRowId+1}', 'Nationality', ['class' => 'col-md-4']) !!}
        ...
        $(document).on('change', '#type_of_iptsp_licensese', function () {
            ...
            if(type_of_iptsp_licensese == 2) return true;
        ...
        $(document).on('change', '#iptsp_licensese_area_division', function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    payment_type: 1,
                    division_id,
                    license_type: $('#type_of_iptsp_licensese').val()
                },
                success: function (response) {
                    if (response.responseCode == -1) {
                        alert(response.msg);
    ...
    // payment part
    @if(!empty($appInfo->isptspli_type) && $appInfo->status_id != 5 )
    const division_id = "{{$appInfo->isptspli_area_div}}";
    let oss_fee = 0;
    let vat = 0;
    $.ajax({
        type: "POST",
        ...
        data: {
            process_type_id: {{ $process_type_id }},
            payment_type: 1,
            division_id: (division_id ? division_id : 0),
            license_type: {{$appInfo->isptspli_type}}
        },
        success: function (response) {
            if (response.responseCode == -1) {
                alert(response.msg);
...
<script type="text/javascript">
    $(function () {
        ...
        datePickerHide('declaration_q1_datetimepicker');

        datePickerHide('declaration_q3_datetimepicker');

        datePickerHide('datetimepickerCommencement');
