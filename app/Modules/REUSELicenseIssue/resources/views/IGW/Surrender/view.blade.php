...
<div class="card" style="border-radius: 10px;" id="applicationForm">
            ...
            <div class="card-body" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-12">
                        <ol>
                            <li>
                                Declaration Has any Application for License of IGW been rejected before?
    ...
    <div class="float-left">
        <a href="{{ url('client/igw-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel"
