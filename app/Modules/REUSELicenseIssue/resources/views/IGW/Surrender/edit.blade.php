        ...
        <div class="col-md-12 col-lg-12" id="inputForm">
            ...
            <div class="card border border-magenta" style="border-radius: 10px; ">
                <div class="card-header" style="display: flex; justify-content: space-between;">
                    <h4 style="border-bottom-width: 0px;">Application For IGW License Surrender</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="float-left">
                        <a href="{{ url('client/igw-license-surrender/list/'. Encryption::encodeId(3)) }}"
...
<script>
    $(document).ready(function() {
        ...
        $('.add_bandwidth_row').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('igw-license-renew/add-bandwidth-row') }}",
                data: {
                    lastRowId: lastRowId,
                },
                success: function(response) {
