...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for IGW License Amendment</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'igw-license-amendment/fetchAppData'])
                    {{-- Company Informaiton --}}
                                    ...
                                    <ol>
                                        <li>
                                            <label class=" !font-normal">
                                                Has any Application for License/ Registration of IGW been
                                                rejected before?
                                            </label>
                                        ...
                                        <li style="margin-top: 20px;" ><span class="i_we_dynamic">I/We</span> hereby certify that <span class="i_we_dynamic">I/We</span> have carefully read the instructions/terms and conditions, for the registration and <span class="i_we_dynamic">I/We</span> undertake to comply with the terms and conditions therein. (Instructions for issuance of registration certificate for the operation of IGW are available at www.btrc.gov.bd.)</li>
