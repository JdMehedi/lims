    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card-header d:flex justify-between">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'igw-license-renew/fetchAppData']){{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                                ...
                                <div class="col-md-12">
                                    <ol>
                                        ...
                                        <li style="margin-top: 20px;"><span class="i_we_dynamic">I/We</span> hereby
                                            ...
                                            for the operation of IGW are available at www.btrc.gov.bd.)
                                        </li>
