    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <h4 class="card-header">Application for IGW License Renew</h4>
            <div class="card-body">
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'igw-license-renew/fetchAppData'])
                ...
                <div class="float-left">
                    <a href="{{ url('client/igw-license-issue/list/'. Encryption::encodeId(38)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.add_row').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('igw-license-issue/add-row') }}",
                data: {
                    tableType: tableType,
                    lastRowId: lastRowId,
                },
