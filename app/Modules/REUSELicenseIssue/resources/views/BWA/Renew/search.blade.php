    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            ...
            <div class="card-body">
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'bwa-license-renew/fetchAppData']){{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/bwa-license-issue/list/'. Encryption::encodeId($process_type_id)) }}"
