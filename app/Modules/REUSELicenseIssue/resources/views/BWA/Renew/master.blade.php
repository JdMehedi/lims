...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            ...
            <div class="card-body">
                {!! Form::open([
                        'url' => url('bwa-license-issue/store'),
                        'method' => 'post',
                ...
                <div class="float-left">
                    <a href="{{ url('client/bwa-license-renew/list/'. Encryption::encodeId($process_type_id)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
