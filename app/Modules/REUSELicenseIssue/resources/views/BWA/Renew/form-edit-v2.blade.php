    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between" >
                <h4 class="float-left" >Application for Renew PSTN Certificate</h4>
                <div class="clearfix">
            ...
            <div class="card-body">
                ...
                <div class="float-left">
                    <a href="{{ url('/bwa-license-renew/list/'. Encryption::encodeId($process_type_id)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
