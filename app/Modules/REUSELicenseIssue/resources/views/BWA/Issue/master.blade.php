...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for PSTN License Issue</h4>
            <div class="card-body">
                {!! Form::open([
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ol>
                                        ...
                                        <li>
                                            <label class=" !font-normal">
                                                Has any License of PSTN issued previously to the Applicant/ any Share Holder/ Partner been cancelled?
                                            </label>
