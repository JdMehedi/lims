    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px;">
            <div class="card-header d:flex justify-between">
                <h4>Application for PSTN License Issue</h4>
                <div class="clearfix">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <ol>
                                        <li>
                                            Has any Application for License of PSTN been rejected before?
                                        ...
                                        <li>
                                            Has any License of PSTN issued previously to the Applicant/ any Share
...
{{--                                        <li>For New Applicant only A, B and E will be applicable.</li>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('/bwa-license-issue/list/'. Encryption::encodeId($process_type_id)) }}"
...
<script>
    ...
    function openPreview() {
        ...
        window.open('<?php echo URL::to( '/bwa-license-issue/preview' ); ?>');
    }
    ...
    function checkApplicationLimit(bwaLicenseType,areaId){
        let app_id = document.getElementById('app_id').value;
        $.ajax({
            type: "POST",
            url: "{{ url('bwa-license-issue/check-application-limit') }}",
            data: {bwaLicenseType,areaId,app_id},
            success: function(response) {
                // error
