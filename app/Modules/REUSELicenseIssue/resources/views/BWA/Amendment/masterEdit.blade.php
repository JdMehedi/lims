    ...
    <div class="col-md-12 col-lg-12" id="AmendmentForm">
        ...
        <div class="card border-magenta">
            <div class="card-header" style="display: flex; justify-content: space-between;">
                <h4 style="border-bottom-width: 0px;">Application For BWA License Amendment</h4>
            ...
            <div class="card-body">
                ...
                <div class="float-left">
                    <a href="{{ url('client/bwa-license-ammendment/list/'. Encryption::encodeId($process_type_id)) }}"
