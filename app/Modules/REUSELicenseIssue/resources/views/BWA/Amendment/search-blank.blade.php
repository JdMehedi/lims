...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <h4 class="card-header">Application for PSTN License Amendment</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                {{--                <br>--}}
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'bwa-license-amendment/fetchAppData'])
                    {{-- Company Informaiton --}}
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submitForm').on('click', function (e) {
            ...
            {{--    // $("form").submit();--}}
            {{--    window.open('<?php echo URL::to('/tc-license-issue/preview'); ?>');--}}
            {{--} else {--}}
