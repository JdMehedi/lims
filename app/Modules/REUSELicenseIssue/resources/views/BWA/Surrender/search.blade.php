...
<div class="row">
    <div class="col-md-12" id="renewForm">
        ...
        <h4 class="card-header">Application for PSTN License Surrender</h4>
            <div class="card-body">
                {!! Form::open([
                                            ...
                                            <div id="if_declaration_q3_yes" style="display: none">
                                                ...
                                                <div style="margin: 5px 0;">
                                                    @isset($appInfo->declaration_q3_doc)
                                                        <input type="hidden" name="declaration_q3_doc" value="{{ $appInfo->declaration_q3_doc }}" />
                ...
                <div class="float-left">
                    <a href="{{ url('client/bwa-license-cancellation/list/'. Encryption::encodeId($process_type_id)) }}"
...
<script>
    ...
    function openPreviewV2() {
        ...
        if(preview) window.open('<?php echo URL::to('/bwa-license-issue/preview'); ?>');
    }
