...
<style>
    ...
    .wizard {
        overflow: viinput_disabledsible;
    }
...
<div id="renewForm">
    ...
    <fieldset>
        ...
        {{-- Company Informaiton --}}
        @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'mnp-license-renew/fetchAppData'])

        {{-- Company Informaiton --}}
        @includeIf('common.subviews.CompanyInfo', ['mode' => 'renew', 'selected' => 1, 'extra' => ['address2']])

        {{-- Applicant Profile --}}
        @includeIf('common.subviews.ApplicantProfile', ['mode' => 'renew', 'selected' => 1, 'extra' => ['address2']])
        {{-- Contact Person --}}
        @includeIf('common.subviews.ContactPerson', ['mode' => 'renew', 'selected' => 1, 'extra' => ['address2']])
        {{-- Share Holder --}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol>
                            ...
                            <li>
                                <label class="required-star !font-normal">
                                    Has any other License/ Registration Certificate of the Applicants/ any
    ...
    <div class="float-left">
        <a href="{{ url('client/mnp-license-renew/list/'. Encryption::encodeId(71)) }}"
