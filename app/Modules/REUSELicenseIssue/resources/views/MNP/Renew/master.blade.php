...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for MNP License Renew</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <div class="float-left">
                    <a href="{{ url('client/mnp-license-renew/list/'. Encryption::encodeId(55)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
