...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application For New MNP License Issue</h4>
            <div class="card-body">
                {!! Form::open([
                                    ...
                                    <ol>
                                        <li>
                                            <label class=" !font-normal">
                                                Has any Application for License of MNP been rejected before?
                                            </label>
                                        ...
                                        <li>
                                            <label class=" !font-normal">
                                                Has any License of MNP issued previously to the Applicant/ any Share Holder/ Partner been cancelled?
                                            </label>
...
{{--                                        <li>For New Applicant only A, B and E will be applicable.</li>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/mnp-license-issue/list/'. Encryption::encodeId(1)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.finish').on('click', function (e) {
            {{--popupWindow = window.open('<?php echo URL::to('/mnp-license-issue/preview'); ?>', 'Sample', '');--}}
            openPreviewV2();
        });
