...
<div class="row">
    <div class="renewForm">
        <div class="card border-magenta">
            <h4 class="card-header">Application for MNP License Surrender</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'mnp-license-cancellation/fetchAppData'])
                    {{-- Company Informaiton --}}
