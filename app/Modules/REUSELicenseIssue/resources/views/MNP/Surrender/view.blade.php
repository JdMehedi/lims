...
<div class="card" style="border-radius: 10px;" id="applicationForm">
    {!! Form::open([
        'url' => url('mnp-license-issue/store'),
        'method' => 'post',
            ...
            <div class="card-body" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-12">
                        <ol>
                            <li>
                                Declaration Has any Application for License of MNP been rejected before?
    ...
    <div class="float-left">
        <a href="{{ url('client/isp-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel"
