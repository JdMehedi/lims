...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for MNP License Amendment</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'mnp-license-amendment/fetchAppData'])
                    {{-- Company Informaiton --}}
