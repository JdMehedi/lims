...
<div class="row" id="fetchedData">
    <div class="col-md-12 col-lg-12" id="inputForm">
        {{-- Industry registration --}}
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for VSAT-HUB Operator/ VSAT User License/ VSAT RT User License Ammendment</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'amendment', 'url' => 'vsat-license-ammendment/fetchAppData'])
                ...
                <div class="float-left">
                    <a href="{{ url('client/vsat-license-issue/list/'. Encryption::encodeId(13)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
