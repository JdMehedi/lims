    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between">
                <h4 class="float-left">Application for VSAT-HUB Operator/ VSAT User License/ VSAT RT User License Amendment</h4>
                <div class="clearfix">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between shareholderHeader">
                            <div>VSAT License Information</div>
                            <div>
                                <label class="amendmentEditBtn">
                                    <input type="checkbox" id="vts_edit" />
                                    EDIT
                                </label>
                            </div>
                        </div>
                ...
                <fieldset>
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between shareholderHeader">
                            <div>SatelliteCommunication Service Provider Information</div>
                            <div>
                                <label class="amendmentEditBtn">
                                    ...
                                    <tr row_id="satelite_{{$index+1}}">
                                        ...
                                        @if($index ===0)
                                            <td class="d-flex justify-content-center">
                                                <button class="btn btn-success rounded-circle btn-sm text-white input_disabled add_row"
                                                        type="button"><i class="fa fa-plus"></i></button>
                                            </td>
                                        @else
                                            <td class="d-flex justify-content-center">
                                                <button
                                                    class="btn btn-danger rounded-circle btn-sm text-white input_disabled remove_row"
                            ...
                            <table class="table table-bordered" id="vsat_tbl">
                                ...
                                @foreach($vsat_hub_info as $index=>$item)
                                    <tr row_id="vsat_{{$index+1}}">
                                        <td class="d-flex justify-content-center ">{{$loop->iteration}}</td>
                                        <td><input type="text" class="form-control input_disabled vsat_place_name"
