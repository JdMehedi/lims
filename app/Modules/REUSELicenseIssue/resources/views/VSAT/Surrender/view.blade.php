...
<div class="card" style="border-radius: 10px;" id="applicationForm">
    ...
    <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('license_categories', 'License Categories',$appInfo->license_category, ['class' => 'col-md-4']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            {!! Form::label('origin_or_satelite', 'Origin or Satelite Type', $appInfo->sattelite_type, ['class' => 'col-md-4 p-r-0']) !!}
                            <div
        ...
        <div class="float-left">
            <a href="{{ url('client/vsat-license-issue/list/'. Encryption::encodeId(14)) }}" class="btn btn-default btn-md cancel"
