    ...
    <div class="col-md-12 col-lg-12" id="inputForm" >
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between">
                <h4 class="card-header">Application for VSAT-HUB Operator/ VSAT User License/ VSAT RT User License
                    Renew</h4>
                <div class="clearfix">
...
{{--                {!! Form::hidden('status_id', $appInfo->status_id, ['class' => 'form-control input-md required', 'id' => 'status_id']) !!}--}}
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'vsat-license-renew/fetchAppData']){{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('license_category') ? 'has-error' : '' }}">
                                            {!! Form::select('license_category', [''=>'Select', '1'=>'VSAT HUB Operator','2'=>'VSAT User','3'=>'VSAT RT User'],$appInfo->license_category,['class' => 'form-control input_disabled', 'id'=> 'license_categories'])!!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            ...
                                            {!! Form::select('origin_or_satelite', [''=>'Select', '1'=>'National Satelite','2'=>'Foreign Satelite'],$appInfo->sattelite_type, ['class' => 'form-control input_disabled', 'id'=> 'origin_or_satelite']) !!}
                ...
                <fieldset>
                    ...
                    <div class="card-header d-flex justify-content-between shareholderHeader">
                            <div>Satellite Communication Service Provider Information</div>
                        <div>
                            <label class="amendmentEditBtn">
                                <input type="checkbox" id="satelite_service_provider" />
                                EDIT
                            </label>
                        </div>
                        </div>
                            ...
                            <table class="table table-bordered" id="equipment_tbl">
                                ...
                                @foreach($vsat_service_provider as $index=>$item)
                                    <tr row_id="satelite_{{$index+1}}">
                                        ...
                                        <td><input type="text" class="form-control service_provider input_disabled"
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between shareholderHeader">
                         <div>  VSAT Hub Operator Information</div>  
                            <div>
                                <label class="amendmentEditBtn">
                                    <input type="checkbox" id="hub_operator_info" />
                                    EDIT
                                </label>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered" id="vsat_tbl">
                                ...
                                @foreach($vsat_hub_info as $index=>$item)
                                    <tr row_id="vsat_{{$index+1}}">
                                        <td class="d-flex justify-content-center">{{$loop->iteration}}</td>
                                        <td><input type="text" class="form-control vsat_place_name input_disabled"
                                                   id="vsat_place_name_{{ $index }}"
                                                   name="vsat_place_name[{{ $index }}]" value="{{$item->place_name}}"
                                                   placeholder="Place name(installed existing)"></td>
                                        <td><input type="number" class="form-control vsat_location input_disabled"
                                        ...
                                        @if($index === 0)
                                            <td class="d-flex justify-content-center">
                                                <button class="btn btn-success input_disabled rounded-circle btn-sm text-white add_row"
                                                        type="button"><i class="fa fa-plus"></i></button>
                                            </td>
                                        @else
                                            <td class="d-flex justify-content-center">
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between shareholderHeader">
                           <div> Technical Specification/ Catalogue </div>
                            <div>
                                <label class="amendmentEditBtn">
                                    <input type="checkbox" id="technical_specification" />
                                    EDIT
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card card-magenta border border-magenta">
                        <div class="card-header d-flex justify-content-between shareholderHeader">
                          <div>  List of Equipment for Monitoring </div> 
                            <div>
                                <label class="amendmentEditBtn">
                                    <input type="checkbox" id="equipment_monitoring" />
                                    EDIT
                                </label>
                            </div>
                        </div>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <div style="margin-top: 20px;display:none;" id="if_declaration_q3_yes">
                                                ...
                                                {{ Form::file('declaration_q3_images',['class'=> "form-control input $declarationRequireClass input_disabled",'id'=>'declaration_q3_images','style'=>'margin-bottom: 20px;'])}}
