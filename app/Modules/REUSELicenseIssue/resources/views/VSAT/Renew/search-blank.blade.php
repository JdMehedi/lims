...
<div class="row" id="fetchedData">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for VSAT-HUB Operator/ VSAT User License/ VSAT RT User License Renew</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'vsat-license-renew/fetchAppData'])
