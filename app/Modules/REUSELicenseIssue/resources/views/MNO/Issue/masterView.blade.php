...
<div class="card-body" id="applicationForm" style="padding: 0px!important;">
                        ...
                        <ol>
                            <li>
                                <label class=" !font-normal">
                                    Has any Application for License/ Registration of MNO License been
                                    rejected before?
                                </label>
                            ...
                            <li style="margin-top: 20px;" ><span class="i_we_dynamic">I/We</span> hereby certify that <span class="i_we_dynamic">I/We</span> have carefully read the instructions/ terms and conditions, for the registration and <span class="i_we_dynamic">I/We</span> undertake to comply with the terms and conditions therein. (Instructions for issuance of registration certificate for the operation of MNO License are available at www.btrc.gov.bd.)</li>
    ...
    <div class="float-left">
        <a href="{{ url('client/mno-license-issue/list/'. Encryption::encodeId(58)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
