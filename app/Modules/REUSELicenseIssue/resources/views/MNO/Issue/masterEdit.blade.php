    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px;">
            <div class="card-header d:flex justify-between">
                <h4>Application For New MNO License Issue</h4>
                <div class="clearfix">
...
{{--                                        <li>For New Applicant only A, B and E will be applicable.</li>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('/mno-license-issue/list/'. Encryption::encodeId(58)) }}"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.add_row').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('mno-license-issue/add-row') }}",
                data: {
                    tableType: tableType,
                    lastRowId: lastRowId,
                },
    ...
    function openPreview() {
        ...
        window.open('<?php echo URL::to( '/mno-license-issue/preview' ); ?>');
    }
