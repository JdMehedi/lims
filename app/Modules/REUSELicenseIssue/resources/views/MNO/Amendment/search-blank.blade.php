...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <h4 class="card-header">Application for MNO License Amendment</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                {{--                <br>--}}
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'mno-license-amendment/fetchAppData'])
                    {{-- Company Informaiton --}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/mno-license-issue/list/'. Encryption::encodeId(60)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
