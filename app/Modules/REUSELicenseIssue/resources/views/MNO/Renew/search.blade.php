...
<div id="renewForm">
    ...
    <fieldset>
        ...
        {{-- Company Informaiton --}}
        @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'mno-license-renew/fetchAppData'])
    ...
    <div class="float-left">
        <a href="{{ url('client/mno-license-renew/list/'. Encryption::encodeId(71)) }}"
