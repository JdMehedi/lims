...
<div class="row">
    <div class="col-md-12 col-lg-12" >
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for IIG License Amendment</h4>
            <div class="card-body">
                {!! Form::open([
                                    ...
                                    <ol>
                                        <li>
                                            <div class=" !font-normal">
                                                Has any Application for License/Registration of IIG been
                                                rejected before?
                                            </div>
                                        ...
                                        <li style="margin-top: 20px;"><span class="i_we_dynamic">I/We</span> hereby
                                            ...
                                            for the operation of IIG are available at www.btrc.gov.bd.)
                                        </li>
