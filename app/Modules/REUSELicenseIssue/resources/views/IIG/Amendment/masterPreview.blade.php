...
//        window.opener.jQuery('#' + id + ' option:[value="' + val + '"]').replaceWith("<option value='" + val + "' selected>" + text + "</option>");
    ...
    window.opener.jQuery("#application_form :input[type=text]").each(function (index) {
        jQuery(this).attr("value", jQuery(this).val());
    });

    window.opener.jQuery("#application_form :input[type=number]").each(function (index) {
        jQuery(this).attr("value", jQuery(this).val());
    });
    ...
    document.getElementById("previewDiv").innerHTML = window.opener.document.getElementById("application_form").innerHTML;
