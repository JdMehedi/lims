...
<div class="card" style="border-radius: 10px;" id="applicationForm">
            ...
            <div class="card-body" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-12">
                        <ol>
                            <li>
                                Declaration Has any Application for License of IIG been rejected before?
                            ...
                            <li>
                                Has any License of IIG issued previously to the Applicant/ any Share Holder/ Partner been cancelled?
    ...
    <div class="float-left">
        <a href="{{ url('client/iig-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel"
