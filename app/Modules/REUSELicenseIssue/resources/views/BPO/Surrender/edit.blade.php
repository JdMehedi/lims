...
<div id="renewForm">
    ...
    @endif
    <div class="card-header d:flex justify-between" style="background: #1C9D50; color: white;">
        <h4 class="float-left">Application for New BPO/ Call Center Certificate Surrender</h4>
        <div class="clearfix">
    ...
    <fieldset>
        ...
        <div class="card card-magenta border border-magenta" style="pointer-events: none;">
            ...
            <div class="card-body" style="padding: 15px 25px;">
                ...
                <div
                    class="col-md-8 {{ $errors->has('present_business_actives') ? 'has-error' : '' }}">
                                            {!! Form::select('present_business_actives', [''=>'Select',1=>'Applicant',2=>'Company',3=>'Group Company'], $appInfo->present_business_actives, ['class' => 'form-control input_disabled', 'id' => 'present_business_actives']) !!}
                ...
                <div style="margin-top: 10px;">
                    {{ Form::textarea('present_business_actives', $appInfo->present_business_actives, array('class' =>'form-control input input_disabled','id' => 'present_business_actives', 'placeholder'=>'Details', 'cols' => 5, 'rows' =>5, '' => '' ))}}
                </div>
            </div>
        </div>
                                        ...
                                        <div class="form-check form-check-inline" style="margin-left: 70px;">
                                            <label class="form-check-label" for="domestic">
                                                @if(json_decode($appInfo->proposal_service_type) != null && in_array('Domestic',json_decode($appInfo->proposal_service_type)))
                                                    <input class="form-check-input" name="proposal_service_type[]" style="pointer-events: none;"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::text("proposal_address[$index]", $areaData->proposal_address, ['class' => 'form-control proposal_address input_disabled', 'placeholder' => 'Enter The Address', 'id' => 'proposal_address_'.($index+(int)1)]) !!}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::number("proposal_no_of_seats[$index]", $areaData->proposal_no_of_seats, ['class' => 'form-control input_disabled', 'placeholder' => 'Enter the No. of Seats', 'id' => 'proposal_no_of_seats_'.($index+(int)1)]) !!}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::number("proposal_employee[$index]", $areaData->proposal_employee, ['class' => 'form-control input_disabled', 'placeholder' => 'Enter The Proposed of Employee', 'id' => 'proposal_employee_'.($index+(int)1)]) !!}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::text("local[$index]", $areaData->local, ['class' => 'form-control input_disabled', 'placeholder' => 'Enter Local', 'id' => 'local_'.($index+(int)1)]) !!}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                class="col-md-8 {{ $errors->has('proposal_employee') ? 'has-error' : '' }}">
                                                                {!! Form::text("expatriate[$index]", $areaData->expatriate, ['class' => 'form-control input_disabled', 'placeholder' => 'Enter Expatriate', 'id' => 'expatriate_'.($index+(int)1)]) !!}
        ...
        @if(count($existingCallCenterDetails))
            @includeIf('REUSELicenseIssue::BPO.Renew.existing-call-center-details', ['mode' => 'surrender'])
        @endif
    </fieldset>
