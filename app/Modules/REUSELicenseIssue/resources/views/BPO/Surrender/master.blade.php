...
{{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('company_type') ? 'has-error' : '' }}">
                                            ...
                                            ?>
                                            {!! Form::select('company_type', $companyType, isset($companyInfo->org_type) ? $companyInfo->org_type : '', ['class' => 'form-control input-disabled',
                ...
                <div class="float-left">
                    <a href="{{ url('client/bwa-license-cancellation/list/'. Encryption::encodeId(77)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
