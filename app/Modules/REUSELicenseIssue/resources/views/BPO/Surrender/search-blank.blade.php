    ...
    <div class="renewForm">
        <div class="card border-magenta">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'bpo-or-call-center-surrender/fetchAppData'])
                    {{-- Company Informaiton --}}
                                                ...
                                                <div class="card card-magenta border border-magenta">
                                                    ...
                                                    <div class="card-body" style="padding: 15px 25px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    {!! Form::label('proposal_employee_1', 'Proposed of Employee', ['class' => 'col-md-4 required-star']) !!}
                                                                    <div
                                                                        class="col-md-8 {{ $errors->has('proposal_employee') ? 'has-error' : '' }}">
                                                                        {!! Form::number('proposal_employee[0]', '', ['class' => 'form-control', 'placeholder' => 'Enter The Proposed of Employee', 'id' => 'proposal_employee_1']) !!}
