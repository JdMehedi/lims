...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for BPO/ Call Center Certificate Issue</h4>
            <div class="card-body">
                {!! Form::open([
...
{{--                                                    {!! Form::select('reg_office_district', $districts, $companyInfo->office_district, ['class' => 'form-control', 'id' => 'reg_office_district', 'onchange' => "getThanaByDistrictId('reg_office_district', this.value, 'reg_office_thana',0)"]) !!}--}}
...
{{--                                                    {!! Form::text('reg_office_address', $companyInfo->address, ['class' => 'form-control', 'placeholder' => 'Enter  Address', 'id' => 'reg_office_address']) !!}--}}
...
{{--                                                    {!! Form::select('noc_district', $districts, '', ['class' => 'form-control', 'id' => 'noc_district', 'onchange' => "getThanaByDistrictId('noc_district', this.value, 'noc_thana',0)"]) !!}--}}
...
{{--                                                    {!! Form::select('noc_thana', [], '', ['class' => 'form-control', 'placeholder' => 'Select district at first', 'id' => 'noc_thana']) !!}--}}
...
{{--                                                    {!! Form::text('noc_address', '', ['class' => 'form-control', 'placeholder' => 'Enter  Address', 'id' => 'noc_address']) !!}--}}
...
{{--                                                ['class' => 'form-control',--}}
{{--                                                'placeholder' => 'Enter Name', 'id' => 'applicant_name', 'readonly' => isset(Auth::user()->user_first_name) ?? 'readonly']) !!}--}}
...
{{--                                            {!! Form::textarea('applicant_address', '', ['class' => 'form-control', 'placeholder' => 'Enter  Address', 'id' => 'applicant_address','rows'=>'1']) !!}--}}
...
{{--                                                'placeholder' => 'Email', 'id' => 'applicant_email', 'readonly' => isset(Auth::user()->user_email) ?? 'readonly']) !!}--}}
...
{{--                                            'placeholder' => 'Enter Mobile Number', 'id' => 'applicant_mobile' , 'readonly' => isset(Auth::user()->user_email) ?? 'readonly', 'onkeyup' => 'mobile_no_validation(this.id)--}}
{{--                                            ']) !!}--}}
...
{{--                                            {!! Form::text('applicant_telephone', '', ['class' => 'form-control', 'placeholder' => 'Enter Telephone Number', 'id' => 'applicant_telephone']) !!}--}}
                                                ...
                                                <div class="card card-magenta border border-magenta">
                                                    ...
                                                    <div class="card-body" style="padding: 15px 25px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    {!! Form::label('proposal_employee_1', 'Proposed no. of Employee', ['class' => 'col-md-4 required-star']) !!}
                                                                    <div
...
{{--                                                                {!! Form::text('shareholder_name[0]', '', ['class' => 'form-control shareholder_name', 'placeholder' => 'Enter Shareholder/partner/proprietor Name', 'id' => 'shareholder_name_1']) !!}--}}
...
{{--                                                                {!! Form::text('shareholder_designation[0]', '', ['class' => 'form-control shareholder_designation', 'placeholder' => 'Enter The Name of Designation', 'id' => 'shareholder_designation_1']) !!}--}}
...
{{--                                                                {!! Form::text('shareholder_email[0]', '', ['class' => 'form-control shareholder_email', 'placeholder' => 'Enter The Email', 'id' => 'shareholder_email_1']) !!}--}}
...
{{--                                                                {!! Form::text('shareholder_mobile[0]', '', ['class' => 'form-control shareholder_mobile', 'placeholder' => 'Mobile Number',  'id' => 'shareholder_mobile_1' ]) !!}--}}
...
{{--                                                                {!! Form::number('shareholder_share_of[0]', '', ['class' => 'form-control shareholder_share_of', 'placeholder' => '', 'id' => 'shareholder_share_of_1']) !!}--}}
...
{{--                                                                {!! Form::number('no_of_share[0]', '', ['class' => 'form-control no-of-share', 'placeholder' => 'Enter % of Share', 'id' => 'no_of_share_1']) !!}--}}
{{--                                                                {!! $errors->first('no_of_share', '<span class="help-block">:message</span>') !!}--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}

{{--                                                        <div class="form-group row" id="nidBlock_1" style="display: none;">--}}
{{--                                                            {!! Form::label('shareholder_nid_1', 'National ID No.', ['class' => 'col-md-4']) !!}--}}
{{--                                                            <div--}}
{{--                                                                class="col-md-8 {{ $errors->has('shareholder_nid') ? 'has-error' : '' }}">--}}
{{--                                                                {!! Form::text('shareholder_nid[0]', '', ['class' => 'form-control shareholder_nid', 'placeholder' => 'Enter National ID No', 'id' => 'shareholder_nid_1']) !!}--}}
...
{{--                                                            {!! Form::label('shareholder_passport_1', 'Passport No.', ['class' => 'col-md-4']) !!}--}}
{{--                                                            <div--}}
{{--                                                                class="col-md-8 {{ $errors->has('shareholder_passport') ? 'has-error' : '' }}">--}}
{{--                                                                {!! Form::text('shareholder_passport[0]', '', ['class' => 'form-control shareholder_passport', 'placeholder' => 'Enter Passport No', 'id' => 'shareholder_passport_1']) !!}--}}
...
{{--                                                                               name="correspondent_photo[0]"--}}
{{--                                                                               id="correspondent_photo_1"--}}
...
{{--                                                                            </figure>--}}
{{--                                                                            <input type="hidden"--}}
{{--                                                                                   id="correspondent_photo_base64_1"--}}
{{--                                                                                   name="correspondent_photo_base64[0]"/>--}}
{{--                                                                        </label>--}}
{{--                                                                    </div>--}}
{{--                                                                </div>--}}
...
{{--                                                                    {!! Form::text('shareholder_dob[0]', '', ['class' => 'form-control shareholder_dob', 'id' => 'shareholder_dob_1']) !!}--}}
...
{{--                                                                {!! Form::select('shareholder_nationality[0]', $nationality, '', ['class' => 'form-control shareholder_nationality', 'id' => 'shareholder_nationality_1']) !!}--}}
...
{{--                                                                {!! Form::number('share_value[0]', '', ['class' => 'form-control share-value', 'placeholder' => 'Enter Share Value', 'id' => 'share_value_1']) !!}--}}
...
{!! Form::label('proposal_no_of_seats_${lastRowId+1}', 'No.of Seats', ['class' => 'col-md-4']) !!}
        ...
        <div class="col-md-6">
            <div class="form-group row">
{!! Form::label('proposal_employee_${lastRowId+1}', 'Proposed no. of Employees', ['class' => 'col-md-4']) !!}
                <div class="col-md-8 {{ $errors->has('proposal_employee') ? 'has-error' : '' }}">
                                                    {!! Form::number('proposal_employee[${lastRowId}]', '', ['class' => 'form-control', 'placeholder' => 'Enter The Proposed no. of Employee', 'id' => 'proposal_employee_${lastRowId+1}']) !!}
                {!! $errors->first('proposal_employee', '<span class="help-block">:message</span>') !!}
                </div>
            </div>
        </div>
