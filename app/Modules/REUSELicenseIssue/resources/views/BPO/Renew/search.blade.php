...
<div class="row">
    <div id="renewForm" style="width: 100% !important;">
        <div class="card border-magenta">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    {{-- Company Informaiton --}}
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-form', 'url' => 'bpo-or-call-center-renew-app/fetchAppData'])
                    {{-- Company Informaiton --}}
...
<script>
    ...
    $(document).ready(function() {
        ...
        @foreach($proposal_area as $index => $parea)
            console.log({{ $parea->proposal_district}},{{ $parea->proposal_thana}} )
        ...
        @if(!empty($appInfo->isp_license_type))
            ...
            $.ajax({
                ...
                complete: function() {
                    ...
                    loadPaymentPanel('', '{{ $process_type_id }}', '2',
                        'payment_panel',
