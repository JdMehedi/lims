...
{{--                </div>--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::select("proposal_district[$index]", $districts, $areaData->proposal_district, ['class' => 'form-control aa_district proposal_district input_disabled','readonly', 'id' => 'proposal_district_'.($index+(int)1), 'onchange' => "getThanaByDistrictId(\"proposal_district_$index\", this.value,\"proposal_thana_$index\",0)"]) !!}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::select("proposal_thana[$index]", [], $areaData->proposal_thana, ['class' => 'form-control aa_thana proposal_thana input_disabled','readonly', 'data-id'=>$areaData->proposal_thana, 'placeholder' => 'Select district at first', 'id' => 'proposal_thana_'.($index+(int)1)]) !!}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div
                                                                ...
                                                                {!! Form::number("proposal_employee[$index]", $areaData->proposal_employee, ['class' => 'form-control input_disabled','readonly', 'placeholder' => 'Enter The Proposed no of Employee', 'id' => 'proposal_employee_'.($index+(int)1)]) !!}
    ...
    <div class="float-left">
        ...
        <div class="float-right">
            ...
            {{--                                class="btn btn-success btn-md" value="submit" name="actionBtn" onclick="openPreviewV2()" >--}}
...
<script>
    ...
    $(document).ready(function() {
        ...
        getThanaByDistrictId('noc_district', {{ $appInfo->op_office_district ?? '' }},
