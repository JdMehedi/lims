...
<div id="renewForm">
    ...
    <fieldset>
        ...
        {{-- Company Informaiton --}}
        @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'ss-license-renew/fetchAppData'])
    ...
    <div class="float-left">
        <a href="{{ url('client/ss-license-renew/list/'. Encryption::encodeId(71)) }}"
