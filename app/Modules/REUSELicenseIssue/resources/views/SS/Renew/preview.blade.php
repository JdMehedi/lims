...
//        window.opener.jQuery('#' + id + ' option:[value="' + val + '"]').replaceWith("<option value='" + val + "' selected>" + text + "</option>");
    ...
    document.getElementById(`type_of_service_section`).innerHTML = `<span class="border-header-txt" style="margin-top: 20px; margin-bottom: 20px;">Type of Service: &nbsp;&nbsp;&nbsp;</span><div class="form-check form-check-inline" style="margin-top: 20px; margin-bottom: 20px;">${getCheckedValue('service_type[]')}</> `;
    let cable_length = window.opener.document.getElementById('cable_length').value;
    //cable_type_section
    document.getElementById(`cable_type_section`).innerHTML = `<span class="border-header-txt" style="margin-bottom: 20px;">Cable Type: &nbsp;&nbsp;&nbsp;</span><div class="form-check form-check-inline" style="margin-bottom: 20px;">${getCheckedValue('cable_type[]')} &nbsp;&nbsp;&nbsp; Cable Length : ${cable_length} </> `;
    ...
    for (let q_item of declaration_q_list) {
        ...
        if(q_item === 'declaration_q3' && q_value === "Yes"  ){
            ...
            console.log(base64encodeIamge,'base64encodeIamge isp Renew')
