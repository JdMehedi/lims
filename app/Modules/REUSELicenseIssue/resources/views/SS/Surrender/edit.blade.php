        ...
        <div class="col-md-12 col-lg-12" id="inputForm">
            ...
            <div class="card border border-magenta" style="border-radius: 10px; ">
                <div class="card-header" style="display: flex; justify-content: space-between;">
                    <h4 style="border-bottom-width: 0px;">Application for Satellite Service License Surrender</h4>
...
{{--                        </div>--}}
                    ...
                    <div class="float-left">
                        <a href="{{ url('client/mnp-license-ammendment/list/'. Encryption::encodeId(3)) }}"
