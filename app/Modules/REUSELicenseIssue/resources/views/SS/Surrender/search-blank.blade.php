    ...
    <div class="renewForm">
        <div class="card border-magenta">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'ss-license-cancellation/fetchAppData'])
                    {{-- Company Informaiton --}}
...
{{--                    </div>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/ss-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
