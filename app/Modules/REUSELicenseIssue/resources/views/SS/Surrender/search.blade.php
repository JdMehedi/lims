...
<div class="row">
    <div class="col-md-12" id="renewForm">
        <div class="card border-magenta">
            <h4 class="card-header">Application for Satellite Service License Surrender</h4>
            <div class="card-body">
                    {!! Form::open([
...
{{--                        </div>--}}
                                    ...
                                    <div class="col-md-12">
                                        <ol>
                                            ...
                                            <li>
                                                ...
                                                @if(($appInfo->declaration_q3 == 'Yes' && !empty($appInfo->declaration_q3_text)))
                                                    <div style="margin-top: 20px;pointer-events: none;">
                                                ...
                                                <div class="row" id="declaration_image" style= "border: none;{{($appInfo->declaration_q3 == 'Yes') ? 'display:block; margin-top: 10px;' :'display:none;'.' margin-bottom: 20px;'}}">
                                                    <div class="col-md-8 d-flex" style="margin-top: 20px;pointer-events: none;">
                                                        ...
                                                        <input type="file"
                                                               value="{{ $appInfo->declaration_q3_doc }}"
                                                        ...
                                                        <input type="hidden" name="declaration_image_file" value="{{$appInfo->declaration_q3_doc}}" >
                                                    </div>
                    ...
                    <div class="float-left">
                        <a href="{{ url('client/ss-license-ammendment/list/'. Encryption::encodeId(3)) }}"
