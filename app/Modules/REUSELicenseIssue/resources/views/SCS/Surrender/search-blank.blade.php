...
<div class="row">
    <div class="renewForm">
        <div class="card border-magenta">
            <h4 class="card-header">Application for SCS License Surrender</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'scs-license-cancellation/fetchAppData'])
                    {{-- Company Informaiton --}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/scs-license-surrender/list/'. Encryption::encodeId(65)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
