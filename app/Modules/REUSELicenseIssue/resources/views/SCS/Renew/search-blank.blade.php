...
{{--    <br>--}}
    ...
    <div class="float-left">
        <a href="{{ url('/scs-license-renew/list/'. Encryption::encodeId($process_type_id)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.finish').on('click', function (e) {
            ...
            popupWindow = window.open('<?php echo URL::to('/scs-license-renew/preview'); ?>', 'Sample', '');
        });
