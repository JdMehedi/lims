    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px;">
            <div class="card-header d:flex justify-between">
                <h4>Application for SCS License Issue</h4>
                <div class="clearfix">
            ...
            <div class="card-body">
                ...
                <div class="float-left">
                    <a href="{{ url('/scs-license-issue/list/'. Encryption::encodeId($process_type_id)) }}"
...
<script>
    ...
    function openPreview() {
        ...
        window.open('<?php echo URL::to( '/scs-license-issue/preview' ); ?>');
    }
