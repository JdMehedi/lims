...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            ...
            <h4 class="card-header">Application for SCS License Issue</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <div class="float-left">
                    <a href="{{ url('client/scs-license-issue/list/'. Encryption::encodeId($process_type_id)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
