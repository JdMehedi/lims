    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border-magenta">
            <div class="card-header" style="display: flex; justify-content: space-between;">
                <h4 style="border-bottom-width: 0px;">Application For TC License Amendment</h4>
            ...
            <div class="card-body">
                ...
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', ['mode' => 'amendment-form-edit', 'selected' => 1])
                                    ...
                                    <ol>
                                        <li>
                                            <div class=" !font-normal">
                                                Has any Application for License/Registration of TC been
                                                rejected before?
                                            </div>
                                        ...
                                        <li style="margin-top: 20px;"><span class="i_we_dynamic">I/We</span> hereby
                                            ...
                                            for the operation of TC are available at www.btrc.gov.bd.)
                                        </li>
