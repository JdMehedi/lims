...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header">Application for TC License Amendment</h4>
            <div class="card-body">
            {!! Form::open([
            ...
            <fieldset>
                @includeIf('common.subviews.licenseInfo', ['mode' => 'amendment', 'selected' => 1])
                                ...
                                <ol>
                                    <li>
                                        <div class=" !font-normal">
                                            Has any Application for License/Registration of TC Center been
                                            rejected before?
                                        </div>
                                    ...
                                    <li style="margin-top: 20px;"><span class="i_we_dynamic">I/We</span> hereby
                                        ...
                                        for the operation of TC Center are available at www.btrc.gov.bd.)
                                    </li>
