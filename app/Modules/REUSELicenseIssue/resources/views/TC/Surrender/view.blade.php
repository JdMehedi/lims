...
<div class="card" style="border-radius: 10px;" id="applicationForm">
    {!! Form::open([
        'url' => url('tc-license-issue/store'),
        'method' => 'post',
                        ...
                        <ol>
                            <li>
                                <label class=" !font-normal">
                                    Has any Application for License/ Registration of TC/ Call Center been
                                    rejected before?
                                </label>
                            ...
                            <li style="margin-top: 20px;" ><span class="i_we_dynamic">I/We</span> hereby certify that <span class="i_we_dynamic">I/We</span> have carefully read the instructions/ terms and conditions, for the registration and <span class="i_we_dynamic">I/We</span> undertake to comply with the terms and conditions therein. (Instructions for issuance of registration certificate for the operation of TC/ Call Center are available at www.btrc.gov.bd.)</li>
    ...
    <div class="float-left">
        <a href="{{ url("client/tc-license-cancellation/list/". Encryption::encodeId($process_type_id)) }}" class="btn btn-default btn-md cancel"
