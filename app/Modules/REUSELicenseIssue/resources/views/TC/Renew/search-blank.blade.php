...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <h4 class="card-header">Application for Tower Sharing License Renew</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'tc-license-renew/fetchAppData'])
                ...
                <div class="float-left">
                    <a href="{{ url('client/tc-license-issue/list/'. Encryption::encodeId(67)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.add_row').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('tc-license-issue/add-row') }}",
                data: {
                    tableType: tableType,
                    lastRowId: lastRowId,
                },
