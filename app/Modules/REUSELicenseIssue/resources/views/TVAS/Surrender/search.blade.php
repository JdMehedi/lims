...
<div class="row">
    <div class="col-md-12" id="renewForm">
        <div class="card border-magenta">
            <h4 class="card-header">Application for TVAS License Surrender </h4>
            <div class="card-body">
                {!! Form::open([
                                    ...
                                    <ol>
                                                ...
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="input-group date datetimepicker4"
                                                             ...
                                                             data-target-input="nearest">
                                                            {!! Form::text('declaration_q3_application_date', ($appInfo->declaration_q1 == 'Yes' && !empty($appInfo->q3_application_date))? \App\Libraries\CommonFunction::changeDateFormat($appInfo->q3_application_date):'', ['class' => 'form-control input_disabled', 'id' => 'declaration_q3_application_date','placeholder'=> date('d-M-Y') ]) !!}
                                                            <div class="input-group-append"
                                        ...
                                        <li>
                                            ...
                                            <div style="margin-top: 20px;" id="declaration_q4">
                                                {{ Form::radio('declaration_q4', 'Yes', $appInfo->declaration_q4 == 'Yes' ? true : false, ['class'=>'form-check-input input_disabled', 'style'=>'display: inline', 'id' => 'declaration_q4_yes']) }}
                                                {{ Form::label('declaration_q4_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                {{ Form::radio('declaration_q4', 'No', $appInfo->declaration_q4 == 'No' ? true : false, ['class'=>'form-check-input input_disabled','style'=>'display: inline;  margin-left:10px;', 'id' => 'declaration_q4_no']) }}
                                            ...
                                            <div id="if_declaration_q4_yes" style="display: none">
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div
                                                        ...
                                                        {!! Form::text('q4_license_number',  $appInfo->q4_license_number, ['class' => 'form-control input_disabled', 'id' => 'q4_license_number', 'placeholder'=> 'Enter License Number']) !!}
                                                    ...
                                                    <div
                                                        ...
                                                        {!! Form::text('q4_case_no',  $appInfo->q4_case_no, ['class' => 'form-control input_disabled', 'id' => 'q4_case_no']) !!}
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        {!! Form::number('q4_amount',  $appInfo->q4_amount, ['class' => 'form-control input_disabled', 'id' => 'q4_amount']) !!}
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        {!! Form::text('q4_bank_draft_no', $appInfo->q4_bank_draft_no, ['class' => 'form-control input_disabled', 'id' => 'q4_bank_draft_no']) !!}
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        ...
                                                        {{ Form::radio('q4_given_comission', 'Yes', $appInfo->q4_given_comission == 'Yes' ? true : false, ['class'=>'form-check-input input_disabled', 'style'=>'display: inline', 'id'=> '' ]) }}
                                                        {{ Form::label('given_comission_yes', 'Yes', ['class' => 'form-check-label','style'=>'display: inline;  margin-left:10px;']) }}

                                                        {{ Form::radio('q4_given_comission', 'No', $appInfo->q4_given_comission == 'No' ? true : false, ['class'=>'form-check-input input_disabled','style'=>'display: inline;  margin-left:10px;', 'id'=> '' ]) }}
                ...
                <div class="float-left">
                    <a href="{{ url('client/tvas-license-cancellation/list/'. Encryption::encodeId(28)) }}"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submitForm').on('click', function (e) {
            ...
            {{--if(preview) window.open('<?php echo URL::to('/tvas-license-issue/preview'); ?>');--}}
        });
