...
<div class="row">
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <h4 class="card-header" style="font-size: 24px; font-weight: 400">Application for Telecommunication Value Added Services  (TVAS) Surrender</h4>
            <div class="card-body">
                {!! Form::open([
                ...
                <div class="float-left">
                    <a href="{{ url('client/tvas-license-cancellation/list/'. Encryption::encodeId(28)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submitForm').on('click', function (e) {
            ...
            {{--    // $("form").submit();--}}
            {{--    window.open('<?php echo URL::to('/tvas-license-issue/preview'); ?>');--}}
            {{--} else {--}}
        ...
        $('.finish').on('click', function (e) {
            ...
            popupWindow = window.open('<?php echo URL::to('/tvas-license-issue/preview'); ?>', 'Sample', '');
        });
