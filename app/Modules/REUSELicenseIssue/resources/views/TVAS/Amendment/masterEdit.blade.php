    ...
    <div class="col-md-12 col-lg-12" id="AmendmentForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between" style="background: #1C9D50; color: white;">
                <h4 class="float-left">Application for TVAS License Amendment</h4>
                <div class="clearfix">
                                                ...
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="input-group date datetimepicker4"
                                                            ...
                                                            {!! Form::text('declaration_q1_application_date', $appInfo->q1_application_date ? \App\Libraries\CommonFunction::changeDateFormat($appInfo->q1_application_date):'', ['class' => 'form-control', 'id' => 'declaration_q1_application_date', 'placeholder'=> date('d-M-Y') ] ) !!}
                                                ...
                                                <div class="form-group row" style="margin-top:10px;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="input-group date datetimepicker4"
                                                             ...
                                                             data-target-input="nearest">
                                                            {!! Form::text('declaration_q3_application_date', $appInfo->q3_application_date ? \App\Libraries\CommonFunction::changeDateFormat($appInfo->q3_application_date):'', ['class' => 'form-control', 'id' => 'declaration_q3_application_date','placeholder'=> date('d-M-Y') ]) !!}
                                                            <div class="input-group-append"
...
<script>
    $(document).ready(function() {
        ...
        $("#declarations").click(function() {
            const elements = document.querySelectorAll('#declarationFields input, #declarationFields label, #declarationFields textarea');
            if (this.checked) {
