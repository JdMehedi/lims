    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            ...
            <div class="card-body">
                ...
                {{--                <br>--}}
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'icx-license-amendment/fetchAppData'])
                    {{-- Company Informaiton --}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/icx-license-issue/list/'. Encryption::encodeId(35)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
