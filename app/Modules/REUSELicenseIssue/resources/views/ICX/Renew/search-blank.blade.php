    ...
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <h4 class="card-header">Application for Interconnection Exchange (ICX) Services License Renew</h4>
            <div class="card-body">
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'icx-license-renew/fetchAppData'])
                ...
                <div class="float-left">
                    <a href="{{ url('client/icx-license-issue/list/'. Encryption::encodeId(34)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
