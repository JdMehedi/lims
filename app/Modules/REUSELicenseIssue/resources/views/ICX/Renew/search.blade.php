...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            ...
            <h4 class="card-header">Application for Interconnection Exchange (ICX) Services License Renew</h4>
...
{{--                {!! Form::hidden('status_id', $appInfo->status_id, ['class' => 'form-control input-md required', 'id' => 'status_id']) !!}--}}
                ...
                {{--                <br>--}}
                <fieldset>
                    @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-serarch', 'url' => 'icx-license-renew/fetchAppData']){{--                    @includeIf('common.subviews.licenseInfo', ['mode' => 'default'])--}}
                ...
                <div class="float-left">
                    <a href="{{ url('client/icx-license-issue/list/'. Encryption::encodeId(34)) }}"
...
<script>
    ...
    @endif
        ...
        var shareholder_check = '<?php echo( ($shareholder_check)?($shareholder_check->is_active):'' ) ?>';
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (newIndex == 1) {
                    ...
                    if (total != 100 && shareholder_check==1) {
        ...
        $('.add_row').click(function () {
            ...
            $.ajax({
                async: false,
                type: "POST",
                url: "{{ url('icx-license-issue/add-row') }}",
                data: {
                    tableType: tableType,
                    lastRowId: lastRowId,
                },
