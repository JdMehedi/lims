    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px;">
            <div class="card-header d:flex justify-between">
                <h4>Application For New ICX License Issue</h4>
                <div class="clearfix">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ol>
                                        ...
                                        <li>
                                            Has any License of ICX issued previously to the Applicant/ any Share
...
{{--                                        <li>For New Applicant only A, B and E will be applicable.</li>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('/icx-license-issue/list/'. Encryption::encodeId(58)) }}"
...
<script>
    ...
    function checkApplicationLimit(ispLicenseType,areaId){
        ...
        $.ajax({
            type: "POST",
            url: "{{ url('icx-license-issue/check-application-limit') }}",
