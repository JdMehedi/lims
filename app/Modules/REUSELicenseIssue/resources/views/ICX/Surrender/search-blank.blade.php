    ...
    <div class="renewForm">
        ...
        <h4 class="card-header">Application for Interconnection Exchange (ICX) Services License Surrender</h4>
            <div class="card-body">
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'icx-license-cancellation/fetchAppData'])
                    {{-- Company Informaiton --}}
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#type_of_isp_licensese").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('icx-license-issue/get-payment-data-by-license-type') }}",
                data: {
