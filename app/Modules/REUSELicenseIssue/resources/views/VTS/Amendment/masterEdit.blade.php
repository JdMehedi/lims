    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div class="card-header d:flex justify-between">
                <h4>Application for VTS License Amendment</h4>
                <div class="clearfix">
            ...
            <div class="card-body">
               ...
               !!}
                ...
                <div class="float-left">
                    <a href="{{ url('client/vsat-license-amendment/list/'. Encryption::encodeId(83)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
