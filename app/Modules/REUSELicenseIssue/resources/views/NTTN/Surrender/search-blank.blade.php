...
<div id="renewForm">
    ...
    <fieldset>
        @include('common.subviews.licenseInfo', ['mode' => 'surrender', 'url' => 'nttn-license-cancellation/fetchAppData'])
        {{-- Company Informaiton --}}
...
{{--        <div id="payment_panel"></div>--}}
    ...
    <div class="float-left">
        <a href="{{ url('client/nttn-license-cancellation/list/'. Encryption::encodeId(53)) }}"
