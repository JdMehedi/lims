...
<div class="row">
    <div class="col-md-12 col-lg-12" id="renewForm">
        ...
        <div class="card-header d:flex justify-between">
            <h4 class="float-left">Application for Nationwide Telecommunication Transmission Network (NTTN) Renew License</h4>
            <div class="clearfix">
        ...
        <fieldset>
            @includeIf('common.subviews.licenseInfo', [ 'mode' => 'renew-form-edit', 'url' => 'nttn-license-renew/fetchAppData'])
