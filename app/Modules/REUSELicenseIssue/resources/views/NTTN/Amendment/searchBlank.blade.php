    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px; ">
            <div style="padding: 10px 15px">
                <h4 class="card-header">Application for NTTN License Amendment</h4>
            </div>
            <div class="card-body">
                {!! Form::open([
                ...
                <fieldset>
                    @include('common.subviews.licenseInfo', ['mode' => 'amendment', 'url' => 'nttn-license-amendment/fetchAppData'])
                ...
                <div class="float-left">
                    <a href="{{ url('client/vts-license-amendment/list/'. Encryption::encodeId(52)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
