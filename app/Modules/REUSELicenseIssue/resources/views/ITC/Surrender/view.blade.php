...
<div class="card" style="border-radius: 10px;" id="applicationForm">
    {!! Form::open([
        'url' => url('itc-license-issue/store'),
        'method' => 'post',
            ...
            <div class="card-body" style="padding: 15px 25px;">
                <div class="row">
                    <div class="col-md-12">
                        <ol>
                            <li>
                                Declaration Has any Application for License of ITC been rejected before?
                            ...
                            <li>
                                Has any License of ITC issued previously to the Applicant/ any Share Holder/ Partner been cancelled?
                            ...
                            <li>
                                ...
                                <div style="margin-top: 60px; margin-left: 5px; display: none;" id="if_declaration_q3_yes">
                                    <a class="btn btn-file" target="_blank" href="{{$appInfo->declaration_q3_doc}}"><i class="fa fa-file"></i> View Document</a>
                                </div>
                            </li>
    ...
    <div class="float-left">
        <a href="{{ url('client/itc-license-surrender/list/'. Encryption::encodeId(4)) }}" class="btn btn-default btn-md cancel"
...
<script>
    ...
    $(document).ready(function () {
        ...
        var type = "{{$appInfo->itc_license_type}}";
        if (type == 1) {
