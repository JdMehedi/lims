...
<div class="card-body" id="applicationForm" style="padding: 0px!important;">
                        ...
                        <ol>
                            <li>
                                <label class=" !font-normal">
                                    Has any Application for License/ Registration of ITC License been
                                    rejected before?
                                </label>
    ...
    <div class="float-left">
        <a href="{{ url('client/itc-license-issue/list/'. Encryption::encodeId(54)) }}" class="btn btn-default btn-md cancel" value="close" name="closeBtn"
