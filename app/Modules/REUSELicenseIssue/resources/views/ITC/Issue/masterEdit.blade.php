    ...
    <div class="col-md-12 col-lg-12" id="inputForm">
        ...
        <div class="card border-magenta" style="border-radius: 10px;">
            <div class="card-header d:flex justify-between">
                <h4>Application for ITC License Issue</h4>
                <div class="clearfix">
                        ...
                        <div class="card-body" style="padding: 15px 25px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <ol>
                                        <li>
                                            Has any Application for License of ITC been rejected before?
                                        ...
                                        <li>
                                            Has any License of ITC issued previously to the Applicant/ any Share
...
{{--                                        <li>For New Applicant only A, B and E will be applicable.</li>--}}
                ...
                <div class="float-left">
                    <a href="{{ url('/itc-license-issue/list/'. Encryption::encodeId(1)) }}"
...
<script>
    ...
    function openPreview() {
        ...
        window.open('<?php echo URL::to( '/itc-license-issue/preview' ); ?>');
    }
