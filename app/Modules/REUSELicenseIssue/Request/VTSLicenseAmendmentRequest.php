...
class VTSLicenseAmendmentRequest {
...
//            $rules['contact_image']          = 'required';
    ...
    public function messages() {
        ...
        $messages['noc_district.required'] = 'Permanent office district is required';
        $messages['noc_thana.required']    = 'Permanent office thana is required';
