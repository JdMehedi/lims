...
class NIXLicenseSurrenderRequest {
...
//            $rules['contact_image']          = 'required';
    ...
    public function messages() {
        ...
        $messages['noc_address.required'] = 'Permanent office district is required';
        $messages['noc_address.required']    = 'Permanent office thana is required';
        $messages['noc_address.required']  = 'Permanent office address is required';
