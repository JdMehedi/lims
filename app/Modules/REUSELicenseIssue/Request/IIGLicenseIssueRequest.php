...
class IIGLicenseIssueRequest extends FormRequest {
    ...
    public function rules(  ) {
        ...
        if ( $request->actionBtn == 'submit' ) {
         ...
         //   $rules['correspondent_photo']     = 'required';
         //   $rules['correspondent_contact_photo'] = 'required';
        }
        return $rules;
    }
    ...
    public function messages() {
        ...
        $messages['op_office_district.required']  = 'Operational office district is required';
        $messages['op_office_thana.required']     = 'Operational office thana is required';
        $messages['op_office_address.required']   = 'Operational office address is required';
        ...
        $messages['correspondent_contact_photo.required'] = 'Contact photo is required';
