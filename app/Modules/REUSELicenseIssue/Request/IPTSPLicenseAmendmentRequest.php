...
class IPTSPLicenseAmendmentRequest
{
    private $request;
    ...
    public function rules() {
        ...
        if($request->shareholder_nationality == 18) $rules['shareholder_nid'] = 'required';
        else $rules['shareholder_passport'] = 'required';
...
//        $rules['types_of_isp_license'] = 'required';
    ...
    public function messages() {
        ...
        $messages['applicant_thana_list.required'] = 'Applicant upazila is required';
        ...
        $messages['contact_photo_base64.required'] = 'Contact person\'s photo is required';
