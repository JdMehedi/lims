...
class ISPLicenseAmendmentRequest {
    ...
    public function rules() {
        ...
        $rules['type_of_isp_licensese'] = 'required';

        if ( $request->type_of_isp_licensese == 2 ) {
            $rules['isp_licensese_area_division'] = 'required';
        }
        if ( $request->type_of_isp_licensese == 3 ) {
            $rules['isp_licensese_area_district'] = 'required';
        }
        if ( $request->type_of_isp_licensese == 4 ) {
            $rules['isp_licensese_area_district'] = 'required';
            $rules['isp_licensese_area_thana']    = 'required';
        }
