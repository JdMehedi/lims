...
namespace App\Modules\REUSELicenseIssue\Models\Special\renew;
...
class SpecialLicenseRenew extends Model implements FormInterface
{

    protected $table = 'special_license_renew';
    ...
    public function viewForm($processTypeId, $appId): JsonResponse
    {
        ...
        $application_data = SpecialLicenseRenew::find($decodedAppId);
        ...
        $data['appInfo'] = ProcessList::leftJoin('special_license_renew as apps', 'apps.id', '=', 'process_list.ref_id')
