...
<div class='row'>
    <div style='text-align: center;'>
        ...
        <br>
        <br>
        <strong style='font-size: 20px;'>INTERNET SERVICE PROVIDER (ISP)</strong>
        <br>
        <br>
        ...
        <br>
        <br>
        <span style='font-size: 20px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$appInfo->org_nm}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br>
        ...
        <br>
        <br>
        {{-- <span style='font-size: 20px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{date('jS')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><strong
            style='font-size: 20px; margin-top: 50px;'>DAY OF</strong><span
            style='font-size: 20px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{date('M').', '.date('Y')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>--}}
        ...
        <strong style='font-size: 18px;'>INTERNET SERVICE PROVIDER (ISP)</strong><br><br>
        ...
        <table class='table-responsive' width='100%' border='1'>
            <tr>
                ...
                <td style='padding: 10px;'><strong style='font-size: 18px;'>{{date('d.M.Y')}}</strong></td>
            </tr>
        </table>
        <br>
        ...
        <span style='font-size: 18px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$appInfo->org_nm}} (Nationwide)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br><br>
        @elseif($appInfo->isp_license_type == 2)
        <span style='font-size: 18px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$appInfo->org_nm}} (Divisional)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br><br>
        @elseif($appInfo->isp_license_type == 3)
        <span style='font-size: 18px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$appInfo->org_nm}} (District)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br><br>
        @elseif($appInfo->isp_license_type == 4)
        <span style='font-size: 18px; border-bottom: 4px dotted #0a001f; padding-bottom: 5px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$appInfo->org_nm}} (Thana/Upazila)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br><br>
        @endif
