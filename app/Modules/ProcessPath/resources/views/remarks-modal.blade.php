...
@php
        use App\Modules\Settings\Models\PdfPrintRequestQueue;
        $pdfLink = PdfPrintRequestQueue::where(['app_id' => $appInfo->id, 'process_type_id' => $appInfo->process_type_id])->where('pdf_diff', '>', 0)->latest()->value('certificate_link');
@endphp
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="list-group">
                    ...
                    @endif
                    @if(!empty($pdfLink))
                        <a target="_blank" href="{{ $pdfLink }}" style="margin-top: 10px;" class="btn btn-primary btn-lg">
