...
<div class="modal-body" id="doc-name-modal">
    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="form-group col-md-12 row">
                ...
                <div class="col-md-9">
                    {!! Form::select('doc_id', $document_list, '', ['class'=>'form-control required input-sm','placeholder'=>'Document name', 'id'=>'doc_id']) !!}
