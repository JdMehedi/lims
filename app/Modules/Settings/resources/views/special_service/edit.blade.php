...
@section('content')
    ...
    <div class="card card-magenta border border-magenta">
                ...
                <div id="multi_section">
                    <div class="card card-magenta border border-magenta" style="margin: 15px;" id="section_1">
                    ...
                    <div class="card-body" <?php echo !env('IS_MOBILE') ? 'style="padding: 15px 25px;"' : '' ?>>
                        ...
                        <div class="col-md-12" id="label_table_div" style="padding: 10px;overflow:visible">
                            <table class="table table-bordered" id="label_table" cellspacing="0" width="100%"
                                ...
                                <tbody id="cost_rows" value="1">
                                
                                <tr style="background-color: lightgrey">
                                
                                    <td>
                                        {!! Form::text('label_1[]', $value = null,  array('class'=>'form-control',
                                        'id'=>"label_1[]")) !!}
                                    </td>
                                
                                    <td>
                                        {!! Form::select('input_type_1[]',$input_type ,$value = null,  array('class'=>'form-control input_type',
                                        'id'=>"input_type_1[]")) !!}
                                    </td>

                                    <td>
                                        {!! Form::text('input_names_1[]' ,$value = null,  array('class'=>'form-control input_names','placeholder' => 'comma separated values',
                                        'id'=>"input_names_1[]")) !!}
                                    </td>
                ...
                <div class="col-md-12" id="attachment_table_div" style="padding: 10px;overflow:visible">
                        <table class="table table-bordered" id="attachment_table" cellspacing="0" width="100%"
                            ...
                            <tr style="background-color: lightgrey">
                                ...
                                <td>
                                    {!! Form::text('file_label[]', $value = null,  array('class'=>'form-control',
                                    'id'=>"file_label[]")) !!}
                                </td>
